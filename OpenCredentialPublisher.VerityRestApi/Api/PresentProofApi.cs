...
namespace OpenCredentialPublisher.VerityRestApi.Api
{
    ...
    /// </summary>
        public interface IPresentProofApi : IApiAccessor
    {
        ...
        /// <returns>PresentProofStatusReport</returns>
        PresentProofStatusReport GetPresentProofStatus (string domainDID, Guid? threadId, string forRelationship, string familyQualifier, string msgName);
        ...
        /// <param name="familyQualifier">msg family qualifier</param>
        /// <param name="msgName">msg name</param>
        /// <returns>ApiResponse of PresentProofStatusReport</returns>
        ApiResponse<PresentProofStatusReport> GetPresentProofStatusWithHttpInfo (string domainDID, Guid? threadId, string forRelationship, string familyQualifier, string msgName);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        PostResponse RequestProof (string domainDID, Guid? threadId, Body2 body = null);
        ...
        ApiResponse<PostResponse> RequestProofWithHttpInfo (string domainDID, Guid? threadId, Body2 body = null);
        ...
        /// <param name="familyQualifier">msg family qualifier</param>
        /// <param name="msgName">msg name</param>
        /// <returns>Task of PresentProofStatusReport</returns>
        System.Threading.Tasks.Task<PresentProofStatusReport> GetPresentProofStatusAsync (string domainDID, Guid? threadId, string forRelationship, string familyQualifier, string msgName);
        ...
        /// <param name="familyQualifier">msg family qualifier</param>
        /// <param name="msgName">msg name</param>
        /// <returns>Task of ApiResponse (PresentProofStatusReport)</returns>
        System.Threading.Tasks.Task<ApiResponse<PresentProofStatusReport>> GetPresentProofStatusAsyncWithHttpInfo (string domainDID, Guid? threadId, string forRelationship, string familyQualifier, string msgName);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<PostResponse> RequestProofAsync (string domainDID, Guid? threadId, Body2 body = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<PostResponse>> RequestProofAsyncWithHttpInfo (string domainDID, Guid? threadId, Body2 body = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
        public partial class PresentProofApi : IPresentProofApi
    {
        private OpenCredentialPublisher.VerityRestApi.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="PresentProofApi"/> class.
        /// </summary>
        /// <returns></returns>
        public PresentProofApi(String basePath)
        {
        ...
        /// <returns></returns>
        public PresentProofApi(OpenCredentialPublisher.VerityRestApi.Client.Configuration configuration = null)
        {
        ...
        /// <param name="msgName">msg name</param>
        /// <returns>PresentProofStatusReport</returns>
        public PresentProofStatusReport GetPresentProofStatus (string domainDID, Guid? threadId, string forRelationship, string familyQualifier, string msgName)
        {
             ApiResponse<PresentProofStatusReport> localVarResponse = GetPresentProofStatusWithHttpInfo(domainDID, threadId, forRelationship, familyQualifier, msgName);
        ...
        /// <param name="msgName">msg name</param>
        /// <returns>ApiResponse of PresentProofStatusReport</returns>
        public ApiResponse< PresentProofStatusReport > GetPresentProofStatusWithHttpInfo (string domainDID, Guid? threadId, string forRelationship, string familyQualifier, string msgName)
        {
            // verify the required parameter 'domainDID' is set
            if (domainDID == null)
                throw new ApiException(400, "Missing required parameter 'domainDID' when calling PresentProofApi->GetPresentProofStatus");
            // verify the required parameter 'threadId' is set
            if (threadId == null)
                throw new ApiException(400, "Missing required parameter 'threadId' when calling PresentProofApi->GetPresentProofStatus");
            // verify the required parameter 'forRelationship' is set
            if (forRelationship == null)
                throw new ApiException(400, "Missing required parameter 'forRelationship' when calling PresentProofApi->GetPresentProofStatus");
            // verify the required parameter 'familyQualifier' is set
            if (familyQualifier == null)
                throw new ApiException(400, "Missing required parameter 'familyQualifier' when calling PresentProofApi->GetPresentProofStatus");
            // verify the required parameter 'msgName' is set
            if (msgName == null)
                throw new ApiException(400, "Missing required parameter 'msgName' when calling PresentProofApi->GetPresentProofStatus");

            var localVarPath = "/api/{domainDID}/present-proof/1.0/{threadId}";
            ...
            {
                Exception exception = ExceptionFactory("GetPresentProofStatus", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<PresentProofStatusReport>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (PresentProofStatusReport) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(PresentProofStatusReport)));
        }
        ...
        /// <param name="msgName">msg name</param>
        /// <returns>Task of PresentProofStatusReport</returns>
        public async System.Threading.Tasks.Task<PresentProofStatusReport> GetPresentProofStatusAsync (string domainDID, Guid? threadId, string forRelationship, string familyQualifier, string msgName)
        {
             ApiResponse<PresentProofStatusReport> localVarResponse = await GetPresentProofStatusAsyncWithHttpInfo(domainDID, threadId, forRelationship, familyQualifier, msgName);
             return localVarResponse.Data;
        ...
        /// <param name="msgName">msg name</param>
        /// <returns>Task of ApiResponse (PresentProofStatusReport)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PresentProofStatusReport>> GetPresentProofStatusAsyncWithHttpInfo (string domainDID, Guid? threadId, string forRelationship, string familyQualifier, string msgName)
        {
            // verify the required parameter 'domainDID' is set
            if (domainDID == null)
                throw new ApiException(400, "Missing required parameter 'domainDID' when calling PresentProofApi->GetPresentProofStatus");
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>PostResponse</returns>
        public PostResponse RequestProof (string domainDID, Guid? threadId, Body2 body = null)
        {
             ApiResponse<PostResponse> localVarResponse = RequestProofWithHttpInfo(domainDID, threadId, body);
             return localVarResponse.Data;
        }
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>ApiResponse of PostResponse</returns>
        public ApiResponse< PostResponse > RequestProofWithHttpInfo (string domainDID, Guid? threadId, Body2 body = null)
        {
            // verify the required parameter 'domainDID' is set
            if (domainDID == null)
                throw new ApiException(400, "Missing required parameter 'domainDID' when calling PresentProofApi->RequestProof");
            // verify the required parameter 'threadId' is set
            if (threadId == null)
                throw new ApiException(400, "Missing required parameter 'threadId' when calling PresentProofApi->RequestProof");
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("RequestProof", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>Task of PostResponse</returns>
        public async System.Threading.Tasks.Task<PostResponse> RequestProofAsync (string domainDID, Guid? threadId, Body2 body = null)
        {
             ApiResponse<PostResponse> localVarResponse = await RequestProofAsyncWithHttpInfo(domainDID, threadId, body);
             return localVarResponse.Data;
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>Task of ApiResponse (PostResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PostResponse>> RequestProofAsyncWithHttpInfo (string domainDID, Guid? threadId, Body2 body = null)
        {
            // verify the required parameter 'domainDID' is set
            if (domainDID == null)
                throw new ApiException(400, "Missing required parameter 'domainDID' when calling PresentProofApi->RequestProof");
