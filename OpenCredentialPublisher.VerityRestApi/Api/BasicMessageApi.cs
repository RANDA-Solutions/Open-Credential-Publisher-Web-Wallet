...
namespace OpenCredentialPublisher.VerityRestApi.Api
{
    ...
    /// </summary>
        public interface IBasicMessageApi : IApiAccessor
    {
        ...
        /// </summary>
        /// <remarks>
        /// Initiates BasicMessage protocol.  Prerequisite for BasicMessage protocol is that you established a Connection with individual.  Sends basic message to individual which contains a content string, sent time, and language localization code.  This is experimental feature and not yet available in Connect.Me. This can be used either with your own developed wallet based on mobile SDK or with other Aries compatible wallets. 
        /// </remarks>
        ...
        PostResponse Message (string domainDID, Guid? threadId, SendMessage body = null);
        ...
        ApiResponse<PostResponse> MessageWithHttpInfo (string domainDID, Guid? threadId, SendMessage body = null);
        ...
        System.Threading.Tasks.Task<PostResponse> MessageAsync (string domainDID, Guid? threadId, SendMessage body = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<PostResponse>> MessageAsyncWithHttpInfo (string domainDID, Guid? threadId, SendMessage body = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
        public partial class BasicMessageApi : IBasicMessageApi
    {
        private OpenCredentialPublisher.VerityRestApi.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="BasicMessageApi"/> class.
        /// </summary>
        /// <returns></returns>
        public BasicMessageApi(String basePath)
        {
        ...
        /// <returns></returns>
        public BasicMessageApi(OpenCredentialPublisher.VerityRestApi.Client.Configuration configuration = null)
        {
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>PostResponse</returns>
        public PostResponse Message (string domainDID, Guid? threadId, SendMessage body = null)
        {
             ApiResponse<PostResponse> localVarResponse = MessageWithHttpInfo(domainDID, threadId, body);
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>ApiResponse of PostResponse</returns>
        public ApiResponse< PostResponse > MessageWithHttpInfo (string domainDID, Guid? threadId, SendMessage body = null)
        {
            // verify the required parameter 'domainDID' is set
            if (domainDID == null)
                throw new ApiException(400, "Missing required parameter 'domainDID' when calling BasicMessageApi->Message");
            // verify the required parameter 'threadId' is set
            if (threadId == null)
                throw new ApiException(400, "Missing required parameter 'threadId' when calling BasicMessageApi->Message");

            var localVarPath = "/api/{domainDID}/basicmessage/1.0/{threadId}";
            ...
            {
                Exception exception = ExceptionFactory("Message", localVarResponse);
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>Task of PostResponse</returns>
        public async System.Threading.Tasks.Task<PostResponse> MessageAsync (string domainDID, Guid? threadId, SendMessage body = null)
        {
             ApiResponse<PostResponse> localVarResponse = await MessageAsyncWithHttpInfo(domainDID, threadId, body);
             return localVarResponse.Data;
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>Task of ApiResponse (PostResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PostResponse>> MessageAsyncWithHttpInfo (string domainDID, Guid? threadId, SendMessage body = null)
        {
            // verify the required parameter 'domainDID' is set
            if (domainDID == null)
                throw new ApiException(400, "Missing required parameter 'domainDID' when calling BasicMessageApi->Message");
