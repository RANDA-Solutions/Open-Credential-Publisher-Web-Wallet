...
namespace OpenCredentialPublisher.VerityRestApi.Api
{
    ...
    /// </summary>
        public interface IUpdateEndpointApi : IApiAccessor
    {
        ...
        PostResponse UpdateEndpoint (string domainDID, UpdateEndpoint body = null);
        ...
        ApiResponse<PostResponse> UpdateEndpointWithHttpInfo (string domainDID, UpdateEndpoint body = null);
        ...
        System.Threading.Tasks.Task<PostResponse> UpdateEndpointAsync (string domainDID, UpdateEndpoint body = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<PostResponse>> UpdateEndpointAsyncWithHttpInfo (string domainDID, UpdateEndpoint body = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
        public partial class UpdateEndpointApi : IUpdateEndpointApi
    {
        private OpenCredentialPublisher.VerityRestApi.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateEndpointApi"/> class.
        /// </summary>
        /// <returns></returns>
        public UpdateEndpointApi(String basePath)
        {
        ...
        /// <returns></returns>
        public UpdateEndpointApi(OpenCredentialPublisher.VerityRestApi.Client.Configuration configuration = null)
        {
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>PostResponse</returns>
        public PostResponse UpdateEndpoint (string domainDID, UpdateEndpoint body = null)
        {
             ApiResponse<PostResponse> localVarResponse = UpdateEndpointWithHttpInfo(domainDID, body);
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>ApiResponse of PostResponse</returns>
        public ApiResponse< PostResponse > UpdateEndpointWithHttpInfo (string domainDID, UpdateEndpoint body = null)
        {
            // verify the required parameter 'domainDID' is set
            if (domainDID == null)
                throw new ApiException(400, "Missing required parameter 'domainDID' when calling UpdateEndpointApi->UpdateEndpoint");

            var localVarPath = "/api/{domainDID}/configs/0.6/";
            ...
            {
                Exception exception = ExceptionFactory("UpdateEndpoint", localVarResponse);
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>Task of PostResponse</returns>
        public async System.Threading.Tasks.Task<PostResponse> UpdateEndpointAsync (string domainDID, UpdateEndpoint body = null)
        {
             ApiResponse<PostResponse> localVarResponse = await UpdateEndpointAsyncWithHttpInfo(domainDID, body);
             return localVarResponse.Data;
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>Task of ApiResponse (PostResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PostResponse>> UpdateEndpointAsyncWithHttpInfo (string domainDID, UpdateEndpoint body = null)
        {
            // verify the required parameter 'domainDID' is set
            if (domainDID == null)
                throw new ApiException(400, "Missing required parameter 'domainDID' when calling UpdateEndpointApi->UpdateEndpoint");
