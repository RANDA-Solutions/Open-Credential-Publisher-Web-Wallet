...
namespace OpenCredentialPublisher.VerityRestApi.Api
{
    ...
    /// </summary>
        public interface IIssueCredentialApi : IApiAccessor
    {
        ...
        /// <param name="forRelationship">DID returned from CreateRelationship request</param>
        /// <param name="familyQualifier">msg family qualifier</param>
        /// <param name="msgName">msg name</param>
        /// <returns>IssueCredentialStatusReport</returns>
        IssueCredentialStatusReport GetIssueCredentialStatus (string domainDID, Guid? threadId, string forRelationship, string familyQualifier, string msgName);
        ...
        /// <param name="familyQualifier">msg family qualifier</param>
        /// <param name="msgName">msg name</param>
        /// <returns>ApiResponse of IssueCredentialStatusReport</returns>
        ApiResponse<IssueCredentialStatusReport> GetIssueCredentialStatusWithHttpInfo (string domainDID, Guid? threadId, string forRelationship, string familyQualifier, string msgName);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        PostResponse IssueCredential (string domainDID, Guid? threadId, Body1 body = null);
        ...
        ApiResponse<PostResponse> IssueCredentialWithHttpInfo (string domainDID, Guid? threadId, Body1 body = null);
        ...
        /// <param name="familyQualifier">msg family qualifier</param>
        /// <param name="msgName">msg name</param>
        /// <returns>Task of IssueCredentialStatusReport</returns>
        System.Threading.Tasks.Task<IssueCredentialStatusReport> GetIssueCredentialStatusAsync (string domainDID, Guid? threadId, string forRelationship, string familyQualifier, string msgName);
        ...
        /// <param name="familyQualifier">msg family qualifier</param>
        /// <param name="msgName">msg name</param>
        /// <returns>Task of ApiResponse (IssueCredentialStatusReport)</returns>
        System.Threading.Tasks.Task<ApiResponse<IssueCredentialStatusReport>> GetIssueCredentialStatusAsyncWithHttpInfo (string domainDID, Guid? threadId, string forRelationship, string familyQualifier, string msgName);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<PostResponse> IssueCredentialAsync (string domainDID, Guid? threadId, Body1 body = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<PostResponse>> IssueCredentialAsyncWithHttpInfo (string domainDID, Guid? threadId, Body1 body = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
        public partial class IssueCredentialApi : IIssueCredentialApi
    {
        private OpenCredentialPublisher.VerityRestApi.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="IssueCredentialApi"/> class.
        /// </summary>
        /// <returns></returns>
        public IssueCredentialApi(String basePath)
        {
        ...
        /// <returns></returns>
        public IssueCredentialApi(OpenCredentialPublisher.VerityRestApi.Client.Configuration configuration = null)
        {
        ...
        /// <param name="msgName">msg name</param>
        /// <returns>IssueCredentialStatusReport</returns>
        public IssueCredentialStatusReport GetIssueCredentialStatus (string domainDID, Guid? threadId, string forRelationship, string familyQualifier, string msgName)
        {
             ApiResponse<IssueCredentialStatusReport> localVarResponse = GetIssueCredentialStatusWithHttpInfo(domainDID, threadId, forRelationship, familyQualifier, msgName);
        ...
        /// <param name="msgName">msg name</param>
        /// <returns>ApiResponse of IssueCredentialStatusReport</returns>
        public ApiResponse< IssueCredentialStatusReport > GetIssueCredentialStatusWithHttpInfo (string domainDID, Guid? threadId, string forRelationship, string familyQualifier, string msgName)
        {
            // verify the required parameter 'domainDID' is set
            if (domainDID == null)
                throw new ApiException(400, "Missing required parameter 'domainDID' when calling IssueCredentialApi->GetIssueCredentialStatus");
            // verify the required parameter 'threadId' is set
            if (threadId == null)
                throw new ApiException(400, "Missing required parameter 'threadId' when calling IssueCredentialApi->GetIssueCredentialStatus");
            // verify the required parameter 'forRelationship' is set
            if (forRelationship == null)
                throw new ApiException(400, "Missing required parameter 'forRelationship' when calling IssueCredentialApi->GetIssueCredentialStatus");
            // verify the required parameter 'familyQualifier' is set
            if (familyQualifier == null)
                throw new ApiException(400, "Missing required parameter 'familyQualifier' when calling IssueCredentialApi->GetIssueCredentialStatus");
            // verify the required parameter 'msgName' is set
            if (msgName == null)
                throw new ApiException(400, "Missing required parameter 'msgName' when calling IssueCredentialApi->GetIssueCredentialStatus");

            var localVarPath = "/api/{domainDID}/issue-credential/1.0/{threadId}";
            ...
            if (msgName != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "msgName", msgName)); // query parameter
            ...
            {
                Exception exception = ExceptionFactory("GetIssueCredentialStatus", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<IssueCredentialStatusReport>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (IssueCredentialStatusReport) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(IssueCredentialStatusReport)));
        }
        ...
        /// <param name="msgName">msg name</param>
        /// <returns>Task of IssueCredentialStatusReport</returns>
        public async System.Threading.Tasks.Task<IssueCredentialStatusReport> GetIssueCredentialStatusAsync (string domainDID, Guid? threadId, string forRelationship, string familyQualifier, string msgName)
        {
             ApiResponse<IssueCredentialStatusReport> localVarResponse = await GetIssueCredentialStatusAsyncWithHttpInfo(domainDID, threadId, forRelationship, familyQualifier, msgName);
             return localVarResponse.Data;
        ...
        /// <param name="msgName">msg name</param>
        /// <returns>Task of ApiResponse (IssueCredentialStatusReport)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<IssueCredentialStatusReport>> GetIssueCredentialStatusAsyncWithHttpInfo (string domainDID, Guid? threadId, string forRelationship, string familyQualifier, string msgName)
        {
            // verify the required parameter 'domainDID' is set
            if (domainDID == null)
                throw new ApiException(400, "Missing required parameter 'domainDID' when calling IssueCredentialApi->GetIssueCredentialStatus");
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>PostResponse</returns>
        public PostResponse IssueCredential (string domainDID, Guid? threadId, Body1 body = null)
        {
             ApiResponse<PostResponse> localVarResponse = IssueCredentialWithHttpInfo(domainDID, threadId, body);
             return localVarResponse.Data;
        }
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>ApiResponse of PostResponse</returns>
        public ApiResponse< PostResponse > IssueCredentialWithHttpInfo (string domainDID, Guid? threadId, Body1 body = null)
        {
            // verify the required parameter 'domainDID' is set
            if (domainDID == null)
                throw new ApiException(400, "Missing required parameter 'domainDID' when calling IssueCredentialApi->IssueCredential");
            // verify the required parameter 'threadId' is set
            if (threadId == null)
                throw new ApiException(400, "Missing required parameter 'threadId' when calling IssueCredentialApi->IssueCredential");
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("IssueCredential", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>Task of PostResponse</returns>
        public async System.Threading.Tasks.Task<PostResponse> IssueCredentialAsync (string domainDID, Guid? threadId, Body1 body = null)
        {
             ApiResponse<PostResponse> localVarResponse = await IssueCredentialAsyncWithHttpInfo(domainDID, threadId, body);
             return localVarResponse.Data;
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>Task of ApiResponse (PostResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PostResponse>> IssueCredentialAsyncWithHttpInfo (string domainDID, Guid? threadId, Body1 body = null)
        {
            // verify the required parameter 'domainDID' is set
            if (domainDID == null)
                throw new ApiException(400, "Missing required parameter 'domainDID' when calling IssueCredentialApi->IssueCredential");
