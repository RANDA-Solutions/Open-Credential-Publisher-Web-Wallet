...
namespace OpenCredentialPublisher.VerityRestApi.Api
{
    ...
    /// </summary>
        public interface IUpdateConfigsApi : IApiAccessor
    {
        ...
        PostResponse UpdateConfigs (string domainDID, Guid? threadId, UpdateConfigsRequest body = null);
        ...
        ApiResponse<PostResponse> UpdateConfigsWithHttpInfo (string domainDID, Guid? threadId, UpdateConfigsRequest body = null);
        ...
        System.Threading.Tasks.Task<PostResponse> UpdateConfigsAsync (string domainDID, Guid? threadId, UpdateConfigsRequest body = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<PostResponse>> UpdateConfigsAsyncWithHttpInfo (string domainDID, Guid? threadId, UpdateConfigsRequest body = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
        public partial class UpdateConfigsApi : IUpdateConfigsApi
    {
        private OpenCredentialPublisher.VerityRestApi.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateConfigsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public UpdateConfigsApi(String basePath)
        {
        ...
        /// <returns></returns>
        public UpdateConfigsApi(OpenCredentialPublisher.VerityRestApi.Client.Configuration configuration = null)
        {
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>PostResponse</returns>
        public PostResponse UpdateConfigs (string domainDID, Guid? threadId, UpdateConfigsRequest body = null)
        {
             ApiResponse<PostResponse> localVarResponse = UpdateConfigsWithHttpInfo(domainDID, threadId, body);
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>ApiResponse of PostResponse</returns>
        public ApiResponse< PostResponse > UpdateConfigsWithHttpInfo (string domainDID, Guid? threadId, UpdateConfigsRequest body = null)
        {
            // verify the required parameter 'domainDID' is set
            if (domainDID == null)
                throw new ApiException(400, "Missing required parameter 'domainDID' when calling UpdateConfigsApi->UpdateConfigs");
            // verify the required parameter 'threadId' is set
            if (threadId == null)
                throw new ApiException(400, "Missing required parameter 'threadId' when calling UpdateConfigsApi->UpdateConfigs");

            var localVarPath = "/api/{domainDID}/update-configs/0.6/{threadId}";
            ...
            {
                Exception exception = ExceptionFactory("UpdateConfigs", localVarResponse);
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>Task of PostResponse</returns>
        public async System.Threading.Tasks.Task<PostResponse> UpdateConfigsAsync (string domainDID, Guid? threadId, UpdateConfigsRequest body = null)
        {
             ApiResponse<PostResponse> localVarResponse = await UpdateConfigsAsyncWithHttpInfo(domainDID, threadId, body);
             return localVarResponse.Data;
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>Task of ApiResponse (PostResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PostResponse>> UpdateConfigsAsyncWithHttpInfo (string domainDID, Guid? threadId, UpdateConfigsRequest body = null)
        {
            // verify the required parameter 'domainDID' is set
            if (domainDID == null)
                throw new ApiException(400, "Missing required parameter 'domainDID' when calling UpdateConfigsApi->UpdateConfigs");
