...
namespace OpenCredentialPublisher.VerityRestApi.Api
{
    ...
    /// </summary>
        public interface IWriteSchemaApi : IApiAccessor
    {
        ...
        PostResponse WriteSchema (string domainDID, Guid? threadId, WriteSchemaRequest body = null);
        ...
        ApiResponse<PostResponse> WriteSchemaWithHttpInfo (string domainDID, Guid? threadId, WriteSchemaRequest body = null);
        ...
        System.Threading.Tasks.Task<PostResponse> WriteSchemaAsync (string domainDID, Guid? threadId, WriteSchemaRequest body = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<PostResponse>> WriteSchemaAsyncWithHttpInfo (string domainDID, Guid? threadId, WriteSchemaRequest body = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
        public partial class WriteSchemaApi : IWriteSchemaApi
    {
        private OpenCredentialPublisher.VerityRestApi.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="WriteSchemaApi"/> class.
        /// </summary>
        /// <returns></returns>
        public WriteSchemaApi(String basePath)
        {
        ...
        /// <returns></returns>
        public WriteSchemaApi(OpenCredentialPublisher.VerityRestApi.Client.Configuration configuration = null)
        {
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>PostResponse</returns>
        public PostResponse WriteSchema (string domainDID, Guid? threadId, WriteSchemaRequest body = null)
        {
             ApiResponse<PostResponse> localVarResponse = WriteSchemaWithHttpInfo(domainDID, threadId, body);
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>ApiResponse of PostResponse</returns>
        public ApiResponse< PostResponse > WriteSchemaWithHttpInfo (string domainDID, Guid? threadId, WriteSchemaRequest body = null)
        {
            // verify the required parameter 'domainDID' is set
            if (domainDID == null)
                throw new ApiException(400, "Missing required parameter 'domainDID' when calling WriteSchemaApi->WriteSchema");
            // verify the required parameter 'threadId' is set
            if (threadId == null)
                throw new ApiException(400, "Missing required parameter 'threadId' when calling WriteSchemaApi->WriteSchema");

            var localVarPath = "/api/{domainDID}/write-schema/0.6/{threadId}";
            ...
            {
                Exception exception = ExceptionFactory("WriteSchema", localVarResponse);
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>Task of PostResponse</returns>
        public async System.Threading.Tasks.Task<PostResponse> WriteSchemaAsync (string domainDID, Guid? threadId, WriteSchemaRequest body = null)
        {
             ApiResponse<PostResponse> localVarResponse = await WriteSchemaAsyncWithHttpInfo(domainDID, threadId, body);
             return localVarResponse.Data;
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>Task of ApiResponse (PostResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PostResponse>> WriteSchemaAsyncWithHttpInfo (string domainDID, Guid? threadId, WriteSchemaRequest body = null)
        {
            // verify the required parameter 'domainDID' is set
            if (domainDID == null)
                throw new ApiException(400, "Missing required parameter 'domainDID' when calling WriteSchemaApi->WriteSchema");
