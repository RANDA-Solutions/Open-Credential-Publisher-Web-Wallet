...
namespace OpenCredentialPublisher.VerityRestApi.Api
{
    ...
    /// </summary>
        public interface IRelationshipApi : IApiAccessor
    {
        ...
        PostResponse Relationship (string domainDID, Guid? threadId, Body body = null);
        ...
        ApiResponse<PostResponse> RelationshipWithHttpInfo (string domainDID, Guid? threadId, Body body = null);
        ...
        System.Threading.Tasks.Task<PostResponse> RelationshipAsync (string domainDID, Guid? threadId, Body body = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<PostResponse>> RelationshipAsyncWithHttpInfo (string domainDID, Guid? threadId, Body body = null);
        ...
        public partial class RelationshipApi : IRelationshipApi
    {
        ...
        /// <returns></returns>
        public RelationshipApi(OpenCredentialPublisher.VerityRestApi.Client.Configuration configuration = null)
        {
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>PostResponse</returns>
        public PostResponse Relationship (string domainDID, Guid? threadId, Body body = null)
        {
             ApiResponse<PostResponse> localVarResponse = RelationshipWithHttpInfo(domainDID, threadId, body);
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>ApiResponse of PostResponse</returns>
        public ApiResponse< PostResponse > RelationshipWithHttpInfo (string domainDID, Guid? threadId, Body body = null)
        {
            // verify the required parameter 'domainDID' is set
            if (domainDID == null)
                throw new ApiException(400, "Missing required parameter 'domainDID' when calling RelationshipApi->Relationship");
            // verify the required parameter 'threadId' is set
            if (threadId == null)
                throw new ApiException(400, "Missing required parameter 'threadId' when calling RelationshipApi->Relationship");

            var localVarPath = "/api/{domainDID}/relationship/1.0/{threadId}";
            ...
            {
                Exception exception = ExceptionFactory("Relationship", localVarResponse);
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>Task of PostResponse</returns>
        public async System.Threading.Tasks.Task<PostResponse> RelationshipAsync (string domainDID, Guid? threadId, Body body = null)
        {
             ApiResponse<PostResponse> localVarResponse = await RelationshipAsyncWithHttpInfo(domainDID, threadId, body);
             return localVarResponse.Data;
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>Task of ApiResponse (PostResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PostResponse>> RelationshipAsyncWithHttpInfo (string domainDID, Guid? threadId, Body body = null)
        {
            // verify the required parameter 'domainDID' is set
            if (domainDID == null)
                throw new ApiException(400, "Missing required parameter 'domainDID' when calling RelationshipApi->Relationship");
