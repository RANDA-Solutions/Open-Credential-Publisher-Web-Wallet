...
namespace OpenCredentialPublisher.VerityRestApi.Api
{
    ...
    /// </summary>
        public interface IWriteCredDefApi : IApiAccessor
    {
        ...
        PostResponse WriteCredDef (string domainDID, Guid? threadId, WriteCredDefRequest body = null);
        ...
        ApiResponse<PostResponse> WriteCredDefWithHttpInfo (string domainDID, Guid? threadId, WriteCredDefRequest body = null);
        ...
        System.Threading.Tasks.Task<PostResponse> WriteCredDefAsync (string domainDID, Guid? threadId, WriteCredDefRequest body = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<PostResponse>> WriteCredDefAsyncWithHttpInfo (string domainDID, Guid? threadId, WriteCredDefRequest body = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
        public partial class WriteCredDefApi : IWriteCredDefApi
    {
        private OpenCredentialPublisher.VerityRestApi.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="WriteCredDefApi"/> class.
        /// </summary>
        /// <returns></returns>
        public WriteCredDefApi(String basePath)
        {
        ...
        /// <returns></returns>
        public WriteCredDefApi(OpenCredentialPublisher.VerityRestApi.Client.Configuration configuration = null)
        {
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>PostResponse</returns>
        public PostResponse WriteCredDef (string domainDID, Guid? threadId, WriteCredDefRequest body = null)
        {
             ApiResponse<PostResponse> localVarResponse = WriteCredDefWithHttpInfo(domainDID, threadId, body);
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>ApiResponse of PostResponse</returns>
        public ApiResponse< PostResponse > WriteCredDefWithHttpInfo (string domainDID, Guid? threadId, WriteCredDefRequest body = null)
        {
            // verify the required parameter 'domainDID' is set
            if (domainDID == null)
                throw new ApiException(400, "Missing required parameter 'domainDID' when calling WriteCredDefApi->WriteCredDef");
            // verify the required parameter 'threadId' is set
            if (threadId == null)
                throw new ApiException(400, "Missing required parameter 'threadId' when calling WriteCredDefApi->WriteCredDef");

            var localVarPath = "/api/{domainDID}/write-cred-def/0.6/{threadId}";
            ...
            {
                Exception exception = ExceptionFactory("WriteCredDef", localVarResponse);
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>Task of PostResponse</returns>
        public async System.Threading.Tasks.Task<PostResponse> WriteCredDefAsync (string domainDID, Guid? threadId, WriteCredDefRequest body = null)
        {
             ApiResponse<PostResponse> localVarResponse = await WriteCredDefAsyncWithHttpInfo(domainDID, threadId, body);
             return localVarResponse.Data;
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>Task of ApiResponse (PostResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PostResponse>> WriteCredDefAsyncWithHttpInfo (string domainDID, Guid? threadId, WriteCredDefRequest body = null)
        {
            // verify the required parameter 'domainDID' is set
            if (domainDID == null)
                throw new ApiException(400, "Missing required parameter 'domainDID' when calling WriteCredDefApi->WriteCredDef");
