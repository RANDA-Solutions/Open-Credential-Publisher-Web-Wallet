...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RequestedProofRevealedAttrs :  IEquatable<RequestedProofRevealedAttrs>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RequestedProofRevealedAttrs" /> class.
        /// </summary>
        /// <param name="identifierIndex">identifierIndex.</param>
        /// <param name="value">value.</param>
        public RequestedProofRevealedAttrs(int? identifierIndex = default(int?), string value = default(string))
        {
        ...
        {
            return this.Equals(input as RequestedProofRevealedAttrs);
        }

        /// <summary>
        /// Returns true if RequestedProofRevealedAttrs instances are equal
        /// </summary>
        /// <param name="input">Instance of RequestedProofRevealedAttrs to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RequestedProofRevealedAttrs input)
        {
            if (input == null)
                return false;
