...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CreateIssuer :  Body3, IEquatable<CreateIssuer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateIssuer" /> class.
        /// </summary>
        /// <param name="type">type (default to &quot;did:sov:123456789abcdefghi1234;spec/issuer-setup/0.6/create&quot;).</param>
        /// <param name="id">random id.</param>
        public CreateIssuer(string type = "did:sov:123456789abcdefghi1234;spec/issuer-setup/0.6/create", Guid? id = default(Guid?))
        {
            // use default value if no "type" provided
            if (type == null)
            {
                this.Type = "did:sov:123456789abcdefghi1234;spec/issuer-setup/0.6/create";
            }
            else
            {
                this.Type = type;
        ...
        {
            return this.Equals(input as CreateIssuer);
        }

        /// <summary>
        /// Returns true if CreateIssuer instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateIssuer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateIssuer input)
        {
            if (input == null)
                return false;
