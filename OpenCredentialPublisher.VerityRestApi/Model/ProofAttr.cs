...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProofAttr :  IEquatable<ProofAttr>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProofAttr" /> class.
        /// </summary>
        /// <param name="name">name.</param>
        /// <param name="names">names.</param>
        /// <param name="restrictions">restrictions.</param>
        /// <param name="nonRevoked">nonRevoked.</param>
        /// <param name="selfAttestAllowed">selfAttestAllowed.</param>
        public ProofAttr(string name = default(string), List<string> names = default(List<string>), List<Restriction> restrictions = default(List<Restriction>), RevocationInterval nonRevoked = default(RevocationInterval), bool? selfAttestAllowed = default(bool?))
        {
            this.Name = name;
            this.Names = names;
        ...
        /// <summary>
        /// Gets or Sets SelfAttestAllowed
        /// </summary>
        [DataMember(Name="self_attest_allowed", EmitDefaultValue=false)]
        public bool? SelfAttestAllowed { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SelfAttestAllowed: ").Append(SelfAttestAllowed).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as ProofAttr);
        }

        /// <summary>
        /// Returns true if ProofAttr instances are equal
        /// </summary>
        /// <param name="input">Instance of ProofAttr to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProofAttr input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.SelfAttestAllowed == input.SelfAttestAllowed ||
                    (this.SelfAttestAllowed != null &&
                    this.SelfAttestAllowed.Equals(input.SelfAttestAllowed))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SelfAttestAllowed != null)
                    hashCode = hashCode * 59 + this.SelfAttestAllowed.GetHashCode();
                return hashCode;
            }
        }
