...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class IssueCred :  IEquatable<IssueCred>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IssueCred" /> class.
        /// </summary>
        /// <param name="credentialsattach">credentialsattach.</param>
        /// <param name="comment">comment.</param>
        /// <param name="pleaseAck">pleaseAck.</param>
        public IssueCred(List<EmbeddingAttachment> credentialsattach = default(List<EmbeddingAttachment>), string comment = default(string), PleaseAck pleaseAck = default(PleaseAck))
        {
        ...
        /// <summary>
        /// Gets or Sets Credentialsattach
        /// </summary>
        [DataMember(Name="credentials~attach", EmitDefaultValue=false)]
        public List<EmbeddingAttachment> Credentialsattach { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Credentialsattach: ").Append(Credentialsattach).Append("\n");
        ...
        {
            return this.Equals(input as IssueCred);
        }

        /// <summary>
        /// Returns true if IssueCred instances are equal
        /// </summary>
        /// <param name="input">Instance of IssueCred to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IssueCred input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.Credentialsattach == input.Credentialsattach ||
                    this.Credentialsattach != null &&
                    input.Credentialsattach != null &&
                    this.Credentialsattach.SequenceEqual(input.Credentialsattach)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Credentialsattach != null)
                    hashCode = hashCode * 59 + this.Credentialsattach.GetHashCode();
