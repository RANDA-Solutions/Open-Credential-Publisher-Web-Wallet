...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OneOfSentIssueCredMsgMsg :  IEquatable<OneOfSentIssueCredMsgMsg>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OneOfSentIssueCredMsgMsg" /> class.
        /// </summary>
        public OneOfSentIssueCredMsgMsg()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OneOfSentIssueCredMsgMsg {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as OneOfSentIssueCredMsgMsg);
        }

        /// <summary>
        /// Returns true if OneOfSentIssueCredMsgMsg instances are equal
        /// </summary>
        /// <param name="input">Instance of OneOfSentIssueCredMsgMsg to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OneOfSentIssueCredMsgMsg input)
        {
            if (input == null)
                return false;
