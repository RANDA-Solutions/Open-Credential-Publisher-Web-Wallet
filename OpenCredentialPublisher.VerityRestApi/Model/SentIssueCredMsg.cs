...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SentIssueCredMsg :  IEquatable<SentIssueCredMsg>, IValidatableObject
    {


        public SentIssueCredMsg() { }

        /// <summary>
        /// Initializes a new instance of the <see cref="SentIssueCredMsg" /> class.
        /// </summary>
        /// <param name="type">type.</param>
        /// <param name="id">random id.</param>
        /// <param name="thread">thread.</param>
        /// <param name="msg">msg.</param>
        public SentIssueCredMsg(string type = default(string), Guid? id = default(Guid?), Thread thread = default(Thread), OneOfSentIssueCredMsgMsg msg = default(OneOfSentIssueCredMsgMsg))
        {
            this.Type = type;
            this.Id = id;
            this.Thread = thread;
        ...
        public OneOfSentIssueCredMsgMsg Msg { get; set; }
        ...
        {
            return this.Equals(input as SentIssueCredMsg);
        }

        /// <summary>
        /// Returns true if SentIssueCredMsg instances are equal
        /// </summary>
        /// <param name="input">Instance of SentIssueCredMsg to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SentIssueCredMsg input)
        {
            if (input == null)
                return false;
