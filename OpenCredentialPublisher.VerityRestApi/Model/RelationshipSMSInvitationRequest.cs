...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RelationshipSMSInvitationRequest : Body, IEquatable<RelationshipSMSInvitationRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RelationshipSMSInvitationRequest" /> class.
        /// </summary>
        /// <param name="type">type (required) (default to &quot;did:sov:123456789abcdefghi1234;spec/relationship/1.0/sms-connection-invitation&quot;).</param>
        /// <param name="id">random id (required).</param>
        /// <param name="forRelationship">forRelationship (required).</param>
        public RelationshipSMSInvitationRequest(string type = "did:sov:123456789abcdefghi1234;spec/relationship/1.0/sms-connection-invitation", Guid? id = default(Guid?), string forRelationship = default(string))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for RelationshipSMSInvitationRequest and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for RelationshipSMSInvitationRequest and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            {
                throw new InvalidDataException("forRelationship is a required property for RelationshipSMSInvitationRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as RelationshipSMSInvitationRequest);
        }

        /// <summary>
        /// Returns true if RelationshipSMSInvitationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RelationshipSMSInvitationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RelationshipSMSInvitationRequest input)
        {
            if (input == null)
                return false;
