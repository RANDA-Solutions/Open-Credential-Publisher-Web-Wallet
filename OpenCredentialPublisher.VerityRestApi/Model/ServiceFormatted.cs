...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ServiceFormatted :  IEquatable<ServiceFormatted>, IValidatableObject
    {
        public ServiceFormatted() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceFormatted" /> class.
        /// </summary>
        /// <param name="id">id (required).</param>
        /// <param name="type">type (required).</param>
        /// <param name="recipientKeys">recipientKeys (required).</param>
        /// <param name="serviceEndpoint">serviceEndpoint (required).</param>
        /// <param name="routingKeys">routingKeys.</param>
        public ServiceFormatted(string id = default(string), string type = default(string), List<string> recipientKeys = default(List<string>), string serviceEndpoint = default(string), List<string> routingKeys = default(List<string>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for ServiceFormatted and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for ServiceFormatted and cannot be null");
            }
            else
            {
                this.Type = type;
            }
            // to ensure "recipientKeys" is required (not null)
            if (recipientKeys == null)
            {
                throw new InvalidDataException("recipientKeys is a required property for ServiceFormatted and cannot be null");
            }
            else
            {
                this.RecipientKeys = recipientKeys;
            }
            // to ensure "serviceEndpoint" is required (not null)
            if (serviceEndpoint == null)
            {
                throw new InvalidDataException("serviceEndpoint is a required property for ServiceFormatted and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Gets or Sets RecipientKeys
        /// </summary>
        [DataMember(Name="recipientKeys", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RecipientKeys: ").Append(RecipientKeys).Append("\n");
        ...
        {
            return this.Equals(input as ServiceFormatted);
        }

        /// <summary>
        /// Returns true if ServiceFormatted instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceFormatted to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceFormatted input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.RecipientKeys == input.RecipientKeys ||
                    this.RecipientKeys != null &&
                    input.RecipientKeys != null &&
                    this.RecipientKeys.SequenceEqual(input.RecipientKeys)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RecipientKeys != null)
                    hashCode = hashCode * 59 + this.RecipientKeys.GetHashCode();
