...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class EmbeddingAttachmentData :  IEquatable<EmbeddingAttachmentData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmbeddingAttachmentData" /> class.
        /// </summary>
        /// <param name="base64">base64 encoded value.</param>
        public EmbeddingAttachmentData(string base64 = default(string))
        {
            this.Base64 = base64;
        }
        ...
        {
            return this.Equals(input as EmbeddingAttachmentData);
        }

        /// <summary>
        /// Returns true if EmbeddingAttachmentData instances are equal
        /// </summary>
        /// <param name="input">Instance of EmbeddingAttachmentData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmbeddingAttachmentData input)
        {
            if (input == null)
                return false;
