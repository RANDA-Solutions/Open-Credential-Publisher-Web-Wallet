...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PresentProofAcceptProposal :  IEquatable<PresentProofAcceptProposal>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PresentProofAcceptProposal" /> class.
        /// </summary>
        /// <param name="type">type (default to &quot;did:sov:BzCbsNYhMrjHiqZDTUASHg;spec/present-proof/1.0/accept-proposal&quot;).</param>
        /// <param name="id">random id.</param>
        /// <param name="forRelationship">forRelationship.</param>
        /// <param name="name">name of proof.</param>
        /// <param name="revocationInterval">revocationInterval.</param>
        public PresentProofAcceptProposal(string type = "did:sov:BzCbsNYhMrjHiqZDTUASHg;spec/present-proof/1.0/accept-proposal", Guid? id = default(Guid?), string forRelationship = default(string), string name = default(string), RevocationInterval revocationInterval = default(RevocationInterval))
        {
            // use default value if no "type" provided
            if (type == null)
            {
                this.Type = "did:sov:BzCbsNYhMrjHiqZDTUASHg;spec/present-proof/1.0/accept-proposal";
            }
            else
            {
                this.Type = type;
        ...
        {
            return this.Equals(input as PresentProofAcceptProposal);
        }

        /// <summary>
        /// Returns true if PresentProofAcceptProposal instances are equal
        /// </summary>
        /// <param name="input">Instance of PresentProofAcceptProposal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PresentProofAcceptProposal input)
        {
            if (input == null)
                return false;
