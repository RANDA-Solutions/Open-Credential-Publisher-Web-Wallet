...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class UpdateConfigsRequest :  IEquatable<UpdateConfigsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateConfigsRequest" /> class.
        /// </summary>
        /// <param name="type">type (required) (default to &quot;did:sov:123456789abcdefghi1234;spec/update-configs/0.6/update&quot;).</param>
        /// <param name="id">random id.</param>
        /// <param name="configs">configs (required).</param>
        public UpdateConfigsRequest(string type = "did:sov:123456789abcdefghi1234;spec/update-configs/0.6/update", Guid? id = default(Guid?), List<ConfigDetail> configs = default(List<ConfigDetail>))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for UpdateConfigsRequest and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (configs == null)
            {
                throw new InvalidDataException("configs is a required property for UpdateConfigsRequest and cannot be null");
            }
            else
            {
        ...
        public List<ConfigDetail> Configs { get; set; }
        ...
        {
            return this.Equals(input as UpdateConfigsRequest);
        }

        /// <summary>
        /// Returns true if UpdateConfigsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateConfigsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateConfigsRequest input)
        {
            if (input == null)
                return false;
