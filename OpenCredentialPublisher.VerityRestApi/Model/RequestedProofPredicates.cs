...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RequestedProofPredicates :  IEquatable<RequestedProofPredicates>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RequestedProofPredicates" /> class.
        /// </summary>
        /// <param name="identifierIndex">identifierIndex (required).</param>
        public RequestedProofPredicates(int? identifierIndex = default(int?))
        {
            // to ensure "identifierIndex" is required (not null)
            if (identifierIndex == null)
            {
                throw new InvalidDataException("identifierIndex is a required property for RequestedProofPredicates and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as RequestedProofPredicates);
        }

        /// <summary>
        /// Returns true if RequestedProofPredicates instances are equal
        /// </summary>
        /// <param name="input">Instance of RequestedProofPredicates to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RequestedProofPredicates input)
        {
            if (input == null)
                return false;
