...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WriteCredDefProblem : IEquatable<WriteCredDefProblem>, IValidatableObject
    {
        public WriteCredDefProblem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WriteCredDefProblem" /> class.
        /// </summary>
        /// <param name="type">type (required).</param>
        /// <param name="thread">thread (required).</param>
        /// <param name="message">message (required).</param>
        public WriteCredDefProblem(string type = default(string), Thread thread = default(Thread), string message = default(string))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for WriteCredDefProblem and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (thread == null)
            {
                throw new InvalidDataException("thread is a required property for WriteCredDefProblem and cannot be null");
            }
            else
            {
                this.Thread = thread;
            ...
            if (message == null)
            {
                throw new InvalidDataException("message is a required property for WriteCredDefProblem and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as WriteCredDefProblem);
        }

        /// <summary>
        /// Returns true if WriteCredDefProblem instances are equal
        /// </summary>
        /// <param name="input">Instance of WriteCredDefProblem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WriteCredDefProblem input)
        {
            if (input == null)
                return false;
