...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ConfigDetail :  IEquatable<ConfigDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfigDetail" /> class.
        /// </summary>
        /// <param name="name">name.</param>
        /// <param name="value">value.</param>
        public ConfigDetail(string name = default(string), string value = default(string))
        {
            this.Name = name;
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as ConfigDetail);
        }

        /// <summary>
        /// Returns true if ConfigDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of ConfigDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConfigDetail input)
        {
            if (input == null)
                return false;
