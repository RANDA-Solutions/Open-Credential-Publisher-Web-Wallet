...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CreateIssuerCreated :  IEquatable<CreateIssuerCreated>, IValidatableObject
    {

        public CreateIssuerCreated() { }

        /// <summary>
        /// Initializes a new instance of the <see cref="CreateIssuerCreated" /> class.
        /// </summary>
        /// <param name="id">random id.</param>
        /// <param name="type">type.</param>
        /// <param name="thread">thread.</param>
        /// <param name="identifier">identifier.</param>
        public CreateIssuerCreated(Guid? id = default(Guid?), string type = default(string), Thread thread = default(Thread), Identifier identifier = default(Identifier))
        {
            this.Id = id;
            this.Type = type;
            this.Thread = thread;
        ...
        {
            return this.Equals(input as CreateIssuerCreated);
        }

        /// <summary>
        /// Returns true if CreateIssuerCreated instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateIssuerCreated to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateIssuerCreated input)
        {
            if (input == null)
                return false;
