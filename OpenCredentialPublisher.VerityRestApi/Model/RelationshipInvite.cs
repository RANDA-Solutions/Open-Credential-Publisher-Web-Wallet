...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RelationshipInvite :  IEquatable<RelationshipInvite>, IValidatableObject
    {

        public RelationshipInvite()
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RelationshipInvite" /> class.
        /// </summary>
        ...
        public RelationshipInvite(string type = "did:sov:123456789abcdefghi1234;spec/relationship/1.0/invitation", Guid? id = default(Guid?), Thread thread = default(Thread), string inviteURL = default(string), string shortInviteURL = default(string), Guid? invitationId = default(Guid?))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for RelationshipInvite and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for RelationshipInvite and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (thread == null)
            {
                throw new InvalidDataException("thread is a required property for RelationshipInvite and cannot be null");
            }
            else
            {
                this.Thread = thread;
            ...
            if (inviteURL == null)
            {
                throw new InvalidDataException("inviteURL is a required property for RelationshipInvite and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as RelationshipInvite);
        }

        /// <summary>
        /// Returns true if RelationshipInvite instances are equal
        /// </summary>
        /// <param name="input">Instance of RelationshipInvite to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RelationshipInvite input)
        {
            if (input == null)
                return false;
