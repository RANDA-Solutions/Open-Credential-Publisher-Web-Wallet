...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TrustPingResponseSent :  IEquatable<TrustPingResponseSent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrustPingResponseSent" /> class.
        /// </summary>
        /// <param name="type">type.</param>
        /// <param name="id">random id.</param>
        /// <param name="thread">thread.</param>
        /// <param name="responseSent">responseSent.</param>
        public TrustPingResponseSent(string type = default(string), Guid? id = default(Guid?), Thread thread = default(Thread), bool? responseSent = default(bool?))
        {
            this.Type = type;
            this.Id = id;
            this.Thread = thread;
        ...
        /// <summary>
        /// Gets or Sets ResponseSent
        /// </summary>
        [DataMember(Name="responseSent", EmitDefaultValue=false)]
        ...
        {
            return this.Equals(input as TrustPingResponseSent);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(TrustPingResponseSent input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.ResponseSent.Equals(input.ResponseSent))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ResponseSent != null)
                    hashCode = hashCode * 59 + this.ResponseSent.GetHashCode();
                return hashCode;
            }
        }
