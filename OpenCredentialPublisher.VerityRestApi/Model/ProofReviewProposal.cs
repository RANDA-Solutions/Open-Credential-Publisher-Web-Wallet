...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProofReviewProposal :  IEquatable<ProofReviewProposal>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProofReviewProposal" /> class.
        /// </summary>
        /// <param name="type">type.</param>
        /// <param name="id">random id.</param>
        /// <param name="thread">thread.</param>
        /// <param name="attributes">array of proposed proof attributes.</param>
        /// <param name="predicates">array of proposed proof predicates.</param>
        /// <param name="comment">Comment with proof proposal.</param>
        public ProofReviewProposal(string type = default(string), Guid? id = default(Guid?), Thread thread = default(Thread), List<ProposedProofAttr> attributes = default(List<ProposedProofAttr>), List<ProposedProofPred> predicates = default(List<ProposedProofPred>), string comment = default(string))
        {
            this.Type = type;
            this.Id = id;
            this.Thread = thread;
        ...
        /// </summary>
        /// <value>array of proposed proof attributes</value>
        [DataMember(Name="attributes", EmitDefaultValue=false)]
        public List<ProposedProofAttr> Attributes { get; set; }

        /// <summary>
        /// array of proposed proof predicates
        /// </summary>
        /// <value>array of proposed proof predicates</value>
        [DataMember(Name="predicates", EmitDefaultValue=false)]
        public List<ProposedProofPred> Predicates { get; set; }

        /// <summary>
        /// Comment with proof proposal
        /// </summary>
        /// <value>Comment with proof proposal</value>
        ...
        {
            return this.Equals(input as ProofReviewProposal);
        }

        /// <summary>
        /// Returns true if ProofReviewProposal instances are equal
        /// </summary>
        /// <param name="input">Instance of ProofReviewProposal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProofReviewProposal input)
        {
            if (input == null)
                return false;
