...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class QuestionStatusReport :  IEquatable<QuestionStatusReport>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuestionStatusReport" /> class.
        /// </summary>
        /// <param name="result">result.</param>
        /// <param name="status">status.</param>
        public QuestionStatusReport(QuestionStatusReportResult result = default(QuestionStatusReportResult), string status = default(string))
        {
            this.Result = result;
            this.Status = status;
        }
        ...
        public QuestionStatusReportResult Result { get; set; }
        ...
        {
            return this.Equals(input as QuestionStatusReport);
        }

        /// <summary>
        /// Returns true if QuestionStatusReport instances are equal
        /// </summary>
        /// <param name="input">Instance of QuestionStatusReport to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuestionStatusReport input)
        {
            if (input == null)
                return false;
