...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProofResult :  IEquatable<ProofResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProofResult" /> class.
        /// </summary>
        ...
        public ProofResult(string type = default(string), Guid? id = default(Guid?), Thread thread = default(Thread), RequestedProof requestedPresentation = default(RequestedProof), string verificationResult = default(string))
        {
            this.Type = type;
            this.Id = id;
            this.Thread = thread;
        ...
        {
            return this.Equals(input as ProofResult);
        }

        /// <summary>
        /// Returns true if ProofResult instances are equal
        /// </summary>
        /// <param name="input">Instance of ProofResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProofResult input)
        {
            if (input == null)
                return false;
