...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class IssueCredentialStatusReportResult :  IEquatable<IssueCredentialStatusReportResult>, IValidatableObject
    {

        public IssueCredentialStatusReportResult() { }

        /// <summary>
        /// Initializes a new instance of the <see cref="IssueCredentialStatusReportResult" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="type">type.</param>
        /// <param name="thread">thread.</param>
        /// <param name="status">status.</param>
        public IssueCredentialStatusReportResult(string id = default(string), string type = default(string), Thread thread = default(Thread), string status = default(string))
        {
            this.Id = id;
            this.Type = type;
            this.Thread = thread;
        ...
        {
            return this.Equals(input as IssueCredentialStatusReportResult);
        }

        /// <summary>
        /// Returns true if IssueCredentialStatusReportResult instances are equal
        /// </summary>
        /// <param name="input">Instance of IssueCredentialStatusReportResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IssueCredentialStatusReportResult input)
        {
            if (input == null)
                return false;
