...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RelationshipCreated :  IEquatable<RelationshipCreated>, IValidatableObject
    {

        public RelationshipCreated() { }

        /// <summary>
        /// Initializes a new instance of the <see cref="RelationshipCreated" /> class.
        /// </summary>
        /// <param name="type">type (required).</param>
        /// <param name="id">random id (required).</param>
        /// <param name="thread">thread (required).</param>
        /// <param name="did">did (required).</param>
        /// <param name="verKey">verKey (required).</param>
        public RelationshipCreated(string type = default(string), Guid? id = default(Guid?), Thread thread = default(Thread), string did = default(string), string verKey = default(string))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for RelationshipCreated and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for RelationshipCreated and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (thread == null)
            {
                throw new InvalidDataException("thread is a required property for RelationshipCreated and cannot be null");
            }
            else
            {
                this.Thread = thread;
            ...
            if (did == null)
            {
                throw new InvalidDataException("did is a required property for RelationshipCreated and cannot be null");
            }
            else
            {
                this.Did = did;
            }
            // to ensure "verKey" is required (not null)
            if (verKey == null)
            {
                throw new InvalidDataException("verKey is a required property for RelationshipCreated and cannot be null");
            }
            else
            {
                this.VerKey = verKey;
        ...
        /// Gets or Sets VerKey
        /// </summary>
        [DataMember(Name="verKey", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  VerKey: ").Append(VerKey).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as RelationshipCreated);
        }

        /// <summary>
        /// Returns true if RelationshipCreated instances are equal
        /// </summary>
        /// <param name="input">Instance of RelationshipCreated to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RelationshipCreated input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.VerKey == input.VerKey ||
                    (this.VerKey != null &&
                    this.VerKey.Equals(input.VerKey))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.VerKey != null)
                    hashCode = hashCode * 59 + this.VerKey.GetHashCode();
                return hashCode;
            }
        }
