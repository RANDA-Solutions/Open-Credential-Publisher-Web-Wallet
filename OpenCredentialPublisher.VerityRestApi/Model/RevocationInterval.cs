...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RevocationInterval :  IEquatable<RevocationInterval>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RevocationInterval" /> class.
        /// </summary>
        /// <param name="from">timestamp.</param>
        /// <param name="to">timestamp.</param>
        public RevocationInterval(int? from = default(int?), int? to = default(int?))
        {
            this.From = from;
            this.To = to;
        }
        ...
        {
            return this.Equals(input as RevocationInterval);
        }

        /// <summary>
        /// Returns true if RevocationInterval instances are equal
        /// </summary>
        /// <param name="input">Instance of RevocationInterval to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RevocationInterval input)
        {
            if (input == null)
                return false;
