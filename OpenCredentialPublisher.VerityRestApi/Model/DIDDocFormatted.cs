...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DIDDocFormatted :  IEquatable<DIDDocFormatted>, IValidatableObject
    {

        public DIDDocFormatted() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DIDDocFormatted" /> class.
        /// </summary>
        /// <param name="context">context (required).</param>
        /// <param name="id">id (required) (default to &quot;did:example:123456789abcdefghi;indy&quot;).</param>
        /// <param name="publicKey">publicKey (required).</param>
        /// <param name="service">service (required).</param>
        public DIDDocFormatted(string context = default(string), string id = "did:example:123456789abcdefghi;indy", List<PublicKeyFormatted> publicKey = default(List<PublicKeyFormatted>), List<ServiceFormatted> service = default(List<ServiceFormatted>))
        {
            // to ensure "context" is required (not null)
            if (context == null)
            {
                throw new InvalidDataException("context is a required property for DIDDocFormatted and cannot be null");
            }
            else
            {
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for DIDDocFormatted and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (publicKey == null)
            {
                throw new InvalidDataException("publicKey is a required property for DIDDocFormatted and cannot be null");
            }
            else
            {
            ...
            if (service == null)
            {
                throw new InvalidDataException("service is a required property for DIDDocFormatted and cannot be null");
            }
            else
            {
        ...
        public List<PublicKeyFormatted> PublicKey { get; set; }

        /// <summary>
        /// Gets or Sets Service
        /// </summary>
        [DataMember(Name="service", EmitDefaultValue=false)]
        public List<ServiceFormatted> Service { get; set; }
        ...
        {
            return this.Equals(input as DIDDocFormatted);
        }

        /// <summary>
        /// Returns true if DIDDocFormatted instances are equal
        /// </summary>
        /// <param name="input">Instance of DIDDocFormatted to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DIDDocFormatted input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.PublicKey.SequenceEqual(input.PublicKey)
                ) && 
                (
