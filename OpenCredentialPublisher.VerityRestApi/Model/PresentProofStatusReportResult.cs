...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PresentProofStatusReportResult :  IEquatable<PresentProofStatusReportResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PresentProofStatusReportResult" /> class.
        /// </summary>
        ...
        public PresentProofStatusReportResult(string type = default(string), Guid? id = default(Guid?), Thread thread = default(Thread), string status = default(string), PresentProofStatusReportResultResults results = default(PresentProofStatusReportResultResults), PresentProofStatusReportResultError error = default(PresentProofStatusReportResultError))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for PresentProofStatusReportResult and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for PresentProofStatusReportResult and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (thread == null)
            {
                throw new InvalidDataException("thread is a required property for PresentProofStatusReportResult and cannot be null");
            }
            else
            {
                this.Thread = thread;
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for PresentProofStatusReportResult and cannot be null");
            }
            else
            {
                this.Status = status;
        ...
        public PresentProofStatusReportResultResults Results { get; set; }

        /// <summary>
        /// Gets or Sets Error
        /// </summary>
        [DataMember(Name="error", EmitDefaultValue=false)]
        public PresentProofStatusReportResultError Error { get; set; }
        ...
        {
            return this.Equals(input as PresentProofStatusReportResult);
        }

        /// <summary>
        /// Returns true if PresentProofStatusReportResult instances are equal
        /// </summary>
        /// <param name="input">Instance of PresentProofStatusReportResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PresentProofStatusReportResult input)
        {
            if (input == null)
                return false;
