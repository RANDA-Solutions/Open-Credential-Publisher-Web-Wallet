...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OneOfbody3 :  IEquatable<OneOfbody3>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OneOfbody3" /> class.
        /// </summary>
        public OneOfbody3()
        {
        }
        ...
        {
            return this.Equals(input as OneOfbody3);
        }

        /// <summary>
        /// Returns true if OneOfbody3 instances are equal
        /// </summary>
        /// <param name="input">Instance of OneOfbody3 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OneOfbody3 input)
        {
            if (input == null)
                return false;
