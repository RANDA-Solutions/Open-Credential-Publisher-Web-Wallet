...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SMSOutOfBandInvitationRequest : Body, IEquatable<SMSOutOfBandInvitationRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SMSOutOfBandInvitationRequest" /> class.
        /// </summary>
        /// <param name="type">type (required) (default to &quot;did:sov:123456789abcdefghi1234;spec/relationship/1.0/sms-out-of-band-invitation&quot;).</param>
        ...
        public SMSOutOfBandInvitationRequest(string type = "did:sov:123456789abcdefghi1234;spec/relationship/1.0/sms-out-of-band-invitation", Guid? id = default(Guid?), string forRelationship = default(string), string goalCode = default(string), string goal = default(string))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for SMSOutOfBandInvitationRequest and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for SMSOutOfBandInvitationRequest and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            {
                throw new InvalidDataException("forRelationship is a required property for SMSOutOfBandInvitationRequest and cannot be null");
            }
            else
            {
            ...
            if (goalCode == null)
            {
                throw new InvalidDataException("goalCode is a required property for SMSOutOfBandInvitationRequest and cannot be null");
            }
            else
            {
            ...
            if (goal == null)
            {
                throw new InvalidDataException("goal is a required property for SMSOutOfBandInvitationRequest and cannot be null");
            }
            else
            {
                this.Goal = goal;
        ...
        {
            return this.Equals(input as SMSOutOfBandInvitationRequest);
        }

        /// <summary>
        /// Returns true if SMSOutOfBandInvitationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SMSOutOfBandInvitationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SMSOutOfBandInvitationRequest input)
        {
            if (input == null)
                return false;
