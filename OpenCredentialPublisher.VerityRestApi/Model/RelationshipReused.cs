...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RelationshipReused :  IEquatable<RelationshipReused>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RelationshipReused" /> class.
        /// </summary>
        /// <param name="type">type.</param>
        /// <param name="id">random id.</param>
        /// <param name="thread">thread.</param>
        public RelationshipReused(string type = default(string), Guid? id = default(Guid?), Thread thread = default(Thread))
        {
            this.Type = type;
            this.Id = id;
            this.Thread = thread;
        ...
        {
            return this.Equals(input as RelationshipReused);
        }

        /// <summary>
        /// Returns true if RelationshipReused instances are equal
        /// </summary>
        /// <param name="input">Instance of RelationshipReused to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RelationshipReused input)
        {
            if (input == null)
                return false;
