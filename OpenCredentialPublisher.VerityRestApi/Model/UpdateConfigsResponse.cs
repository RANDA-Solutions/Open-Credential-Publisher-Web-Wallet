...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class UpdateConfigsResponse :  IEquatable<UpdateConfigsResponse>, IValidatableObject
    {

        public UpdateConfigsResponse() { }

        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateConfigsResponse" /> class.
        /// </summary>
        /// <param name="type">type (required).</param>
        /// <param name="thread">thread.</param>
        /// <param name="configs">configs (required).</param>
        public UpdateConfigsResponse(string type = default(string), Thread thread = default(Thread), List<ConfigDetail> configs = default(List<ConfigDetail>))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for UpdateConfigsResponse and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (configs == null)
            {
                throw new InvalidDataException("configs is a required property for UpdateConfigsResponse and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as UpdateConfigsResponse);
        }

        /// <summary>
        /// Returns true if UpdateConfigsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateConfigsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateConfigsResponse input)
        {
            if (input == null)
                return false;
