...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProposedProofAttr :  IEquatable<ProposedProofAttr>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProposedProofAttr" /> class.
        /// </summary>
        /// <param name="name">The name of attribute.</param>
        /// <param name="credDefId">The optional cred_def_id key maps to the credential definition identifier of the credential with the current attribute.</param>
        /// <param name="mimeType">The optional mime-type advises the verifier how to render a binary attribute, to judge its content for applicability before accepting a presentation containing it. Its value parses case-insensitively in keeping with MIME type semantics of RFC 2045. If mime-type is missing, then value is string..</param>
        /// <param name="value">The optional value of attribute..</param>
        /// <param name="referent">The optional referent can be useful in specifying multiple-credential presentations. Its value indicates which credential will supply the attribute in the presentation. Sharing a referent value between multiple attribute specifications indicates that the holder&#x27;s same credential supplies the attribute..</param>
        public ProposedProofAttr(string name = default(string), string credDefId = default(string), string mimeType = default(string), string value = default(string), string referent = default(string))
        {
            this.Name = name;
        ...
        /// </summary>
        /// <value>The name of attribute</value>
        ...
        /// </summary>
        /// <value>The optional cred_def_id key maps to the credential definition identifier of the credential with the current attribute</value>
        ...
        /// </summary>
        /// <value>The optional mime-type advises the verifier how to render a binary attribute, to judge its content for applicability before accepting a presentation containing it. Its value parses case-insensitively in keeping with MIME type semantics of RFC 2045. If mime-type is missing, then value is string.</value>
        ...
        /// </summary>
        /// <value>The optional value of attribute.</value>
        ...
        /// </summary>
        /// <value>The optional referent can be useful in specifying multiple-credential presentations. Its value indicates which credential will supply the attribute in the presentation. Sharing a referent value between multiple attribute specifications indicates that the holder&#x27;s same credential supplies the attribute.</value>
        ...
        {
            return this.Equals(input as ProposedProofAttr);
        }

        /// <summary>
        /// Returns true if ProposedProofAttr instances are equal
        /// </summary>
        /// <param name="input">Instance of ProposedProofAttr to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProposedProofAttr input)
        {
            if (input == null)
                return false;
