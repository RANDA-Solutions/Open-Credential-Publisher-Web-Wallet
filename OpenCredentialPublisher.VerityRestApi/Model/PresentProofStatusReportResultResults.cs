...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PresentProofStatusReportResultResults :  IEquatable<PresentProofStatusReportResultResults>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PresentProofStatusReportResultResults" /> class.
        /// </summary>
        /// <param name="requestedPresentation">requestedPresentation.</param>
        /// <param name="verificationResult">verificationResult.</param>
        public PresentProofStatusReportResultResults(RequestedProof requestedPresentation = default(RequestedProof), string verificationResult = default(string))
        {
        ...
        /// <summary>
        /// Gets or Sets RequestedPresentation
        /// </summary>
        [DataMember(Name="requested_presentation", EmitDefaultValue=false)]
        public RequestedProof RequestedPresentation { get; set; }

        /// <summary>
        /// Gets or Sets VerificationResult
        /// </summary>
        [DataMember(Name="verification_result", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RequestedPresentation: ").Append(RequestedPresentation).Append("\n");
        ...
        {
            return this.Equals(input as PresentProofStatusReportResultResults);
        }

        /// <summary>
        /// Returns true if PresentProofStatusReportResultResults instances are equal
        /// </summary>
        /// <param name="input">Instance of PresentProofStatusReportResultResults to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PresentProofStatusReportResultResults input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.RequestedPresentation == input.RequestedPresentation ||
                    (this.RequestedPresentation != null &&
                    this.RequestedPresentation.Equals(input.RequestedPresentation))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.RequestedPresentation != null)
                    hashCode = hashCode * 59 + this.RequestedPresentation.GetHashCode();
