...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class IssueCredential :  Body1, IEquatable<IssueCredential>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IssueCredential" /> class.
        /// </summary>
        /// <param name="type">type (required) (default to &quot;did:sov:BzCbsNYhMrjHiqZDTUASHg;spec/issue-credential/1.0/issue&quot;).</param>
        /// <param name="id">random id (required).</param>
        /// <param name="forRelationship">DID returned from CreateRelationship (required).</param>
        /// <param name="pleaseAck">pleaseAck.</param>
        /// <param name="revRegistryId">revocation registry id.</param>
        /// <param name="comment">comment.</param>
        public IssueCredential(string type = "did:sov:BzCbsNYhMrjHiqZDTUASHg;spec/issue-credential/1.0/issue", Guid? id = default(Guid?), string forRelationship = default(string), PleaseAck pleaseAck = default(PleaseAck), string revRegistryId = default(string), string comment = default(string))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for IssueCredential and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for IssueCredential and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            {
                throw new InvalidDataException("forRelationship is a required property for IssueCredential and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Gets or Sets PleaseAck
        /// </summary>
        [DataMember(Name="~please_ack", EmitDefaultValue=false)]
        public PleaseAck PleaseAck { get; set; }

        /// <summary>
        /// revocation registry id
        /// </summary>
        /// <value>revocation registry id</value>
        [DataMember(Name="revRegistryId", EmitDefaultValue=false)]
        public string RevRegistryId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PleaseAck: ").Append(PleaseAck).Append("\n");
            sb.Append("  RevRegistryId: ").Append(RevRegistryId).Append("\n");
        ...
        {
            return this.Equals(input as IssueCredential);
        }

        /// <summary>
        /// Returns true if IssueCredential instances are equal
        /// </summary>
        /// <param name="input">Instance of IssueCredential to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IssueCredential input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.PleaseAck == input.PleaseAck ||
                    (this.PleaseAck != null &&
                    this.PleaseAck.Equals(input.PleaseAck))
                ) && 
                (
                    this.RevRegistryId == input.RevRegistryId ||
                    (this.RevRegistryId != null &&
                    this.RevRegistryId.Equals(input.RevRegistryId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PleaseAck != null)
                    hashCode = hashCode * 59 + this.PleaseAck.GetHashCode();
                if (this.RevRegistryId != null)
                    hashCode = hashCode * 59 + this.RevRegistryId.GetHashCode();
