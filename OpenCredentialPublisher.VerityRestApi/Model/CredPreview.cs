...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CredPreview :  IEquatable<CredPreview>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CredPreview" /> class.
        /// </summary>
        /// <param name="type">type (required).</param>
        /// <param name="attributes">attributes (required).</param>
        public CredPreview(string type = default(string), List<CredPreviewAttribute> attributes = default(List<CredPreviewAttribute>))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for CredPreview and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for CredPreview and cannot be null");
            }
            else
            {
        ...
        public List<CredPreviewAttribute> Attributes { get; set; }
        ...
        {
            return this.Equals(input as CredPreview);
        }

        /// <summary>
        /// Returns true if CredPreview instances are equal
        /// </summary>
        /// <param name="input">Instance of CredPreview to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CredPreview input)
        {
            if (input == null)
                return false;
