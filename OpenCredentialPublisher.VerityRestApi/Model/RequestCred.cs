...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RequestCred :  IEquatable<RequestCred>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RequestCred" /> class.
        /// </summary>
        /// <param name="requestsattach">requestsattach (required).</param>
        /// <param name="comment">comment.</param>
        public RequestCred(List<EmbeddingAttachment> requestsattach = default(List<EmbeddingAttachment>), string comment = default(string))
        {
            // to ensure "requestsattach" is required (not null)
            if (requestsattach == null)
            {
                throw new InvalidDataException("requestsattach is a required property for RequestCred and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Gets or Sets Requestsattach
        /// </summary>
        [DataMember(Name="requests~attach", EmitDefaultValue=false)]
        public List<EmbeddingAttachment> Requestsattach { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Requestsattach: ").Append(Requestsattach).Append("\n");
        ...
        {
            return this.Equals(input as RequestCred);
        }

        /// <summary>
        /// Returns true if RequestCred instances are equal
        /// </summary>
        /// <param name="input">Instance of RequestCred to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RequestCred input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.Requestsattach == input.Requestsattach ||
                    this.Requestsattach != null &&
                    input.Requestsattach != null &&
                    this.Requestsattach.SequenceEqual(input.Requestsattach)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Requestsattach != null)
                    hashCode = hashCode * 59 + this.Requestsattach.GetHashCode();
