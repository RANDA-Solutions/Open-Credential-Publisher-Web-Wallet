...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PleaseAck :  IEquatable<PleaseAck>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PleaseAck" /> class.
        /// </summary>
        public PleaseAck()
        {
        }
        ...
        {
            return this.Equals(input as PleaseAck);
        }

        /// <summary>
        /// Returns true if PleaseAck instances are equal
        /// </summary>
        /// <param name="input">Instance of PleaseAck to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PleaseAck input)
        {
            if (input == null)
                return false;
