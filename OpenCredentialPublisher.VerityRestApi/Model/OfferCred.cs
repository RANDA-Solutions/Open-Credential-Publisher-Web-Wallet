...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OfferCred :  IEquatable<OfferCred>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OfferCred" /> class.
        /// </summary>
        /// <param name="credentialPreview">credentialPreview (required).</param>
        /// <param name="offersattach">offersattach (required).</param>
        /// <param name="comment">comment.</param>
        /// <param name="price">price.</param>
        public OfferCred(CredPreview credentialPreview = default(CredPreview), List<EmbeddingAttachment> offersattach = default(List<EmbeddingAttachment>), string comment = default(string), string price = default(string))
        {
            // to ensure "credentialPreview" is required (not null)
            if (credentialPreview == null)
            {
                throw new InvalidDataException("credentialPreview is a required property for OfferCred and cannot be null");
            }
            else
            {
                this.CredentialPreview = credentialPreview;
            }
            // to ensure "offersattach" is required (not null)
            if (offersattach == null)
            {
                throw new InvalidDataException("offersattach is a required property for OfferCred and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Gets or Sets CredentialPreview
        /// </summary>
        [DataMember(Name="credential_preview", EmitDefaultValue=false)]
        public CredPreview CredentialPreview { get; set; }

        /// <summary>
        /// Gets or Sets Offersattach
        /// </summary>
        [DataMember(Name="offers~attach", EmitDefaultValue=false)]
        public List<EmbeddingAttachment> Offersattach { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CredentialPreview: ").Append(CredentialPreview).Append("\n");
            sb.Append("  Offersattach: ").Append(Offersattach).Append("\n");
        ...
        {
            return this.Equals(input as OfferCred);
        }

        /// <summary>
        /// Returns true if OfferCred instances are equal
        /// </summary>
        /// <param name="input">Instance of OfferCred to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OfferCred input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.CredentialPreview == input.CredentialPreview ||
                    (this.CredentialPreview != null &&
                    this.CredentialPreview.Equals(input.CredentialPreview))
                ) && 
                (
                    this.Offersattach == input.Offersattach ||
                    this.Offersattach != null &&
                    input.Offersattach != null &&
                    this.Offersattach.SequenceEqual(input.Offersattach)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.CredentialPreview != null)
                    hashCode = hashCode * 59 + this.CredentialPreview.GetHashCode();
                if (this.Offersattach != null)
                    hashCode = hashCode * 59 + this.Offersattach.GetHashCode();
