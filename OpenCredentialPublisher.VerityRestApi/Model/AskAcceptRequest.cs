...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AskAcceptRequest :  IEquatable<AskAcceptRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AskAcceptRequest" /> class.
        /// </summary>
        /// <param name="comment">comment.</param>
        /// <param name="requestsattach">requestsattach.</param>
        public AskAcceptRequest(string comment = default(string), List<EmbeddingAttachment> requestsattach = default(List<EmbeddingAttachment>))
        {
        ...
        {
            return this.Equals(input as AskAcceptRequest);
        }

        /// <summary>
        /// Returns true if AskAcceptRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AskAcceptRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AskAcceptRequest input)
        {
            if (input == null)
                return false;
