...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ConnectionMsg :  IEquatable<ConnectionMsg>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConnectionMsg" /> class.
        /// </summary>
        /// <param name="dID">dID (required).</param>
        /// <param name="dIDDoc">dIDDoc (required).</param>
        public ConnectionMsg(string dID = default(string), DIDDocFormatted dIDDoc = default(DIDDocFormatted))
        {
            // to ensure "dID" is required (not null)
            if (dID == null)
            {
                throw new InvalidDataException("dID is a required property for ConnectionMsg and cannot be null");
            }
            else
            {
                this.DID = dID;
            ...
            if (dIDDoc == null)
            {
                throw new InvalidDataException("dIDDoc is a required property for ConnectionMsg and cannot be null");
            }
            else
            {
                this.DIDDoc = dIDDoc;
        ...
        /// Gets or Sets DIDDoc
        /// </summary>
        [DataMember(Name="DIDDoc", EmitDefaultValue=false)]
        public DIDDocFormatted DIDDoc { get; set; }
        ...
        {
            return this.Equals(input as ConnectionMsg);
        }

        /// <summary>
        /// Returns true if ConnectionMsg instances are equal
        /// </summary>
        /// <param name="input">Instance of ConnectionMsg to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConnectionMsg input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.DIDDoc == input.DIDDoc ||
                    (this.DIDDoc != null &&
                    this.DIDDoc.Equals(input.DIDDoc))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DIDDoc != null)
                    hashCode = hashCode * 59 + this.DIDDoc.GetHashCode();
                return hashCode;
            }
        }
