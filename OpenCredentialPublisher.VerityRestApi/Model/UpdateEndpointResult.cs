...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class UpdateEndpointResult :  IEquatable<UpdateEndpointResult>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateEndpointResult" /> class.
        /// </summary>
        /// <param name="type">type.</param>
        /// <param name="id">Webhook id.</param>
        public UpdateEndpointResult(string type = default(string), string id = default(string))
        {
            this.Type = type;
            this.Id = id;
        }
        ...
        {
            return this.Equals(input as UpdateEndpointResult);
        }

        /// <summary>
        /// Returns true if UpdateEndpointResult instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateEndpointResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateEndpointResult input)
        {
            if (input == null)
                return false;
