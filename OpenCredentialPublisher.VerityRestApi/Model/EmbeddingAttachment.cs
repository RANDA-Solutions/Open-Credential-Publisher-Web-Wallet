...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class EmbeddingAttachment :  IEquatable<EmbeddingAttachment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmbeddingAttachment" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="mimeType">mimeType.</param>
        /// <param name="data">data.</param>
        public EmbeddingAttachment(string id = default(string), string mimeType = default(string), EmbeddingAttachmentData data = default(EmbeddingAttachmentData))
        {
            this.Id = id;
        ...
        public EmbeddingAttachmentData Data { get; set; }
        ...
        {
            return this.Equals(input as EmbeddingAttachment);
        }

        /// <summary>
        /// Returns true if EmbeddingAttachment instances are equal
        /// </summary>
        /// <param name="input">Instance of EmbeddingAttachment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmbeddingAttachment input)
        {
            if (input == null)
                return false;
