...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ConnResponseSent :  IEquatable<ConnResponseSent>, IValidatableObject
    {

        public ConnResponseSent() { }

        /// <summary>
        /// Initializes a new instance of the <see cref="ConnResponseSent" /> class.
        /// </summary>
        /// <param name="type">type (required).</param>
        /// <param name="id">random id (required).</param>
        /// <param name="thread">thread (required).</param>
        /// <param name="myDID">myDID (required).</param>
        /// <param name="resp">resp (required).</param>
        public ConnResponseSent(string type = default(string), Guid? id = default(Guid?), Thread thread = default(Thread), string myDID = default(string), ConnResponseMsg resp = default(ConnResponseMsg))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for ConnResponseSent and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for ConnResponseSent and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (thread == null)
            {
                throw new InvalidDataException("thread is a required property for ConnResponseSent and cannot be null");
            }
            else
            {
                this.Thread = thread;
            }
            // to ensure "myDID" is required (not null)
            if (myDID == null)
            {
                throw new InvalidDataException("myDID is a required property for ConnResponseSent and cannot be null");
            }
            else
            {
                this.MyDID = myDID;
            }
            // to ensure "resp" is required (not null)
            if (resp == null)
            {
                throw new InvalidDataException("resp is a required property for ConnResponseSent and cannot be null");
            }
            else
            {
                this.Resp = resp;
        ...
        public ConnResponseMsg Resp { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  MyDID: ").Append(MyDID).Append("\n");
        ...
        {
            return this.Equals(input as ConnResponseSent);
        }

        /// <summary>
        /// Returns true if ConnResponseSent instances are equal
        /// </summary>
        /// <param name="input">Instance of ConnResponseSent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConnResponseSent input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.MyDID == input.MyDID ||
                    (this.MyDID != null &&
                    this.MyDID.Equals(input.MyDID))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MyDID != null)
                    hashCode = hashCode * 59 + this.MyDID.GetHashCode();
                if (this.Resp != null)
