...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CredPreviewAttribute :  IEquatable<CredPreviewAttribute>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CredPreviewAttribute" /> class.
        /// </summary>
        /// <param name="name">name (required).</param>
        /// <param name="value">value (required).</param>
        /// <param name="mimeType">mimeType.</param>
        public CredPreviewAttribute(string name = default(string), string value = default(string), string mimeType = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for CredPreviewAttribute and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (value == null)
            {
                throw new InvalidDataException("value is a required property for CredPreviewAttribute and cannot be null");
            }
            else
            {
                this.Value = value;
        ...
        {
            return this.Equals(input as CredPreviewAttribute);
        }

        /// <summary>
        /// Returns true if CredPreviewAttribute instances are equal
        /// </summary>
        /// <param name="input">Instance of CredPreviewAttribute to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CredPreviewAttribute input)
        {
            if (input == null)
                return false;
