...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateCredentialSchemaMessage : IEquatable<UpdateCredentialSchemaMessage>, IValidatableObject
    {

        public UpdateCredentialSchemaMessage() { }

        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateCredentialSchemaMessage" /> class.
        /// </summary>
        /// <param name="type">type (required).</param>
        /// <param name="schemaId">credDefId (required).</param>
        /// <param name="threadId">threadId (required).</param>"
        /// 
        public UpdateCredentialSchemaMessage(string type = default(string), string schemaId = default(string), string threadId = default(string))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for UpdateCredentialSchemaMessage and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (schemaId == null)
            {
                throw new InvalidDataException("schemaId is a required property for UpdateCredentialSchemaMessage and cannot be null");
            }
            else
            {
            ...
            if (threadId == null)
            {
                throw new InvalidDataException("threadId is a required property for UpdateCredentialSchemaMessage and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateCredentialSchemaMessage {\n");
        ...
        {
            return this.Equals(input as UpdateCredentialSchemaMessage);
        }

        /// <summary>
        /// Returns true if UpdateCredentialSchemaMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateCredentialSchemaMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateCredentialSchemaMessage input)
        {
            if (input == null)
                return false;
