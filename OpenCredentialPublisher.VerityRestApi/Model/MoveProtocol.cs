...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MoveProtocol :  IEquatable<MoveProtocol>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MoveProtocol" /> class.
        /// </summary>
        /// <param name="type">type.</param>
        /// <param name="id">random id.</param>
        /// <param name="thread">thread.</param>
        /// <param name="responseSent">responseSent.</param>
        public MoveProtocol(string type = default(string), Guid? id = default(Guid?), Guid? threadId = default(Guid?), Thread thread = default(Thread), string fromRelationship = default(string), string toRelationship = default(string), string protocolReference = default(string))
        {
            this.Type = type;
            this.Id = id;
            this.Thread = thread;
        ...
        [DataMember(Name = "protoRefStr", EmitDefaultValue = false)]
        public string ProtocolReference { get; set; }

        [DataMember(Name = "fromRelationship", EmitDefaultValue = false)]
        public string FromRelationship { get; set; }

        [DataMember(Name="toRelationship", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  FromRelationship: ").Append(FromRelationship).Append("\n");
            sb.Append("  ToRelationship: ").Append(ToRelationship).Append("\n");
            sb.Append("  ThreadId: ").Append(ThreadId).Append("\n");
            sb.Append("  Thread: ").Append(Thread).Append("\n");
            sb.Append("  ProtocolReference: ").Append(ProtocolReference).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as MoveProtocol);
        }

        /// <summary>
        /// Returns true if TrustPingResponseSent instances are equal
        /// </summary>
        /// <param name="input">Instance of TrustPingResponseSent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MoveProtocol input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.FromRelationship == input.FromRelationship ||
                    (this.FromRelationship != null &&
                     this.FromRelationship.Equals(input.FromRelationship))
                ) &&
                (
                    this.ToRelationship == input.ToRelationship ||
                    (this.ToRelationship != null &&
                    this.ToRelationship.Equals(input.ToRelationship))
                ) &&
                (
                ...
                (
                    this.ProtocolReference == input.ProtocolReference ||
                    (this.ProtocolReference != null &&
                    this.ProtocolReference.Equals(input.ProtocolReference))
                );
        }
