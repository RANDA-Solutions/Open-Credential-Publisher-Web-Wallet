...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class UpdateEndpointMethod :  IEquatable<UpdateEndpointMethod>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateEndpointMethod" /> class.
        /// </summary>
        /// <param name="id">Webhook id (default to &quot;webhook&quot;).</param>
        /// <param name="value">value.</param>
        /// <param name="type">Webhook type (default to 2).</param>
        /// <param name="packaging">packaging.</param>
        public UpdateEndpointMethod(string id = "webhook", string value = default(string), int? type = 2, UpdateEndpointPackaging packaging = default(UpdateEndpointPackaging))
        {
        ...
        public UpdateEndpointPackaging Packaging { get; set; }
        ...
        {
            return this.Equals(input as UpdateEndpointMethod);
        }

        /// <summary>
        /// Returns true if UpdateEndpointMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateEndpointMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateEndpointMethod input)
        {
            if (input == null)
                return false;
