...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OneOfbody2 :  IEquatable<OneOfbody2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OneOfbody2" /> class.
        /// </summary>
        public OneOfbody2()
        {
        }
        ...
        {
            return this.Equals(input as OneOfbody2);
        }

        /// <summary>
        /// Returns true if OneOfbody2 instances are equal
        /// </summary>
        /// <param name="input">Instance of OneOfbody2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OneOfbody2 input)
        {
            if (input == null)
                return false;
