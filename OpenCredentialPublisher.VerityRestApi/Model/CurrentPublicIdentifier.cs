...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CurrentPublicIdentifier :  Body3, IEquatable<CurrentPublicIdentifier>, IValidatableObject
    {

        public CurrentPublicIdentifier() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CurrentPublicIdentifier" /> class.
        /// </summary>
        /// <param name="type">type (default to &quot;did:sov:123456789abcdefghi1234;spec/issuer-setup/0.6/current-public-identifier&quot;).</param>
        /// <param name="id">random id.</param>
        public CurrentPublicIdentifier(string type = "did:sov:123456789abcdefghi1234;spec/issuer-setup/0.6/current-public-identifier", Guid? id = default(Guid?))
        {
            // use default value if no "type" provided
            if (type == null)
            {
                this.Type = "did:sov:123456789abcdefghi1234;spec/issuer-setup/0.6/current-public-identifier";
            }
            else
            {
                this.Type = type;
        ...
        {
            return this.Equals(input as CurrentPublicIdentifier);
        }

        /// <summary>
        /// Returns true if CurrentPublicIdentifier instances are equal
        /// </summary>
        /// <param name="input">Instance of CurrentPublicIdentifier to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CurrentPublicIdentifier input)
        {
            if (input == null)
                return false;
