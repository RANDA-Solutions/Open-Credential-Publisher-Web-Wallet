...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CreateRelationship : Body, IEquatable<CreateRelationship>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateRelationship" /> class.
        /// </summary>
        /// <param name="type">type (required) (default to &quot;did:sov:123456789abcdefghi1234;spec/relationship/1.0/create&quot;).</param>
        /// <param name="id">random id (required).</param>
        /// <param name="label">Inviter label, usually company name.</param>
        /// <param name="logoUrl">URL of the Inviter logo.</param>
        /// <param name="phoneNumber">Phone number in +international format.</param>
        public CreateRelationship(string type = "did:sov:123456789abcdefghi1234;spec/relationship/1.0/create", Guid? id = default(Guid?), string label = default(string), string logoUrl = default(string), string phoneNumber = default(string))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for CreateRelationship and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for CreateRelationship and cannot be null");
            }
            else
            {
                this.Id = id;
        ...
        /// </summary>
        /// <value>Inviter label, usually company name</value>
        ...
        /// </summary>
        /// <value>URL of the Inviter logo</value>
        ...
        {
            return this.Equals(input as CreateRelationship);
        }

        /// <summary>
        /// Returns true if CreateRelationship instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateRelationship to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateRelationship input)
        {
            if (input == null)
                return false;
