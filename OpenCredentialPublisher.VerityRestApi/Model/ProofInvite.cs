...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProofInvite :  IEquatable<ProofInvite>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProofInvite" /> class.
        /// </summary>
        ...
        public ProofInvite(string type = default(string), Guid? id = default(Guid?), Thread thread = default(Thread), string inviteURL = default(string), string shortInviteURL = default(string), Guid? invitationId = default(Guid?))
        {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for ProofInvite and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for ProofInvite and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (thread == null)
            {
                throw new InvalidDataException("thread is a required property for ProofInvite and cannot be null");
            }
            else
            {
                this.Thread = thread;
            ...
            if (inviteURL == null)
            {
                throw new InvalidDataException("inviteURL is a required property for ProofInvite and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ProofInvite);
        }

        /// <summary>
        /// Returns true if ProofInvite instances are equal
        /// </summary>
        /// <param name="input">Instance of ProofInvite to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProofInvite input)
        {
            if (input == null)
                return false;
