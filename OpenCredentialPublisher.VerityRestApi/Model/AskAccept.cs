...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AskAccept :  IEquatable<AskAccept>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AskAccept" /> class.
        /// </summary>
        /// <param name="type_">type_.</param>
        /// <param name="id">random id.</param>
        /// <param name="thread">thread.</param>
        /// <param name="request">request.</param>
        public AskAccept(string type_ = default(string), Guid? id = default(Guid?), Thread thread = default(Thread), AskAcceptRequest request = default(AskAcceptRequest))
        {
            this.Type_ = type_;
            this.Id = id;
            this.Thread = thread;
        ...
        public AskAcceptRequest Request { get; set; }
        ...
        {
            return this.Equals(input as AskAccept);
        }

        /// <summary>
        /// Returns true if AskAccept instances are equal
        /// </summary>
        /// <param name="input">Instance of AskAccept to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AskAccept input)
        {
            if (input == null)
                return false;
