...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RequestedProofUnrevealedAttrs :  IEquatable<RequestedProofUnrevealedAttrs>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RequestedProofUnrevealedAttrs" /> class.
        /// </summary>
        /// <param name="identifierIndex">identifierIndex (required).</param>
        public RequestedProofUnrevealedAttrs(int? identifierIndex = default(int?))
        {
            // to ensure "identifierIndex" is required (not null)
            if (identifierIndex == null)
            {
                throw new InvalidDataException("identifierIndex is a required property for RequestedProofUnrevealedAttrs and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("  IdentifierIndex: ").Append(IdentifierIndex).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as RequestedProofUnrevealedAttrs);
        }

        /// <summary>
        /// Returns true if RequestedProofUnrevealedAttrs instances are equal
        /// </summary>
        /// <param name="input">Instance of RequestedProofUnrevealedAttrs to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RequestedProofUnrevealedAttrs input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.IdentifierIndex == input.IdentifierIndex ||
                    (this.IdentifierIndex != null &&
                    this.IdentifierIndex.Equals(input.IdentifierIndex))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IdentifierIndex != null)
                    hashCode = hashCode * 59 + this.IdentifierIndex.GetHashCode();
                return hashCode;
            }
        }
