...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AcceptCredProposalProposal :  IEquatable<AcceptCredProposalProposal>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AcceptCredProposalProposal" /> class.
        /// </summary>
        /// <param name="credDefId">id of credential definition used.</param>
        /// <param name="credentialProposal">credentialProposal.</param>
        /// <param name="comment">comment.</param>
        public AcceptCredProposalProposal(string credDefId = default(string), CredPreview credentialProposal = default(CredPreview), string comment = default(string))
        {
        ...
        /// <summary>
        /// Gets or Sets CredentialProposal
        /// </summary>
        [DataMember(Name="credential_proposal", EmitDefaultValue=false)]
        public CredPreview CredentialProposal { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CredentialProposal: ").Append(CredentialProposal).Append("\n");
        ...
        {
            return this.Equals(input as AcceptCredProposalProposal);
        }

        /// <summary>
        /// Returns true if AcceptCredProposalProposal instances are equal
        /// </summary>
        /// <param name="input">Instance of AcceptCredProposalProposal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AcceptCredProposalProposal input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.CredentialProposal == input.CredentialProposal ||
                    (this.CredentialProposal != null &&
                    this.CredentialProposal.Equals(input.CredentialProposal))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CredentialProposal != null)
                    hashCode = hashCode * 59 + this.CredentialProposal.GetHashCode();
