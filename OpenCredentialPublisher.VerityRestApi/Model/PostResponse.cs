...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PostResponse :  IEquatable<PostResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostResponse" /> class.
        /// </summary>
        /// <param name="status">status (required).</param>
        /// <param name="errorCode">Present only if status is Error.</param>
        /// <param name="errorDetails">Present only if status is Error.</param>
        public PostResponse(string status = default(string), string errorCode = default(string), string errorDetails = default(string))
        {
            // to ensure "status" is required (not null)
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for PostResponse and cannot be null");
            }
            else
            {
                this.Status = status;
        ...
        /// </summary>
        /// <value>Present only if status is Error</value>
        ...
        /// </summary>
        /// <param name="input">Instance of PostResponse to be compared</param>
        /// <returns>Boolean</returns>
