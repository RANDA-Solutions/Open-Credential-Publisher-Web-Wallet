...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProposedProofPred :  IEquatable<ProposedProofPred>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProposedProofPred" /> class.
        /// </summary>
        /// <param name="name">The name of attribute in predicate.</param>
        /// <param name="credDefId">The cred_def_id key maps to the credential definition identifier of the credential with the current attribute.</param>
        /// <param name="predicate">The predicate operator.</param>
        /// <param name="threshold">The threshold value for the predicate..</param>
        public ProposedProofPred(string name = default(string), string credDefId = default(string), string predicate = default(string), int? threshold = default(int?))
        {
            this.Name = name;
        ...
        /// </summary>
        /// <value>The name of attribute in predicate</value>
        ...
        /// </summary>
        /// <value>The cred_def_id key maps to the credential definition identifier of the credential with the current attribute</value>
        ...
        /// </summary>
        /// <value>The predicate operator</value>
        ...
        /// </summary>
        /// <value>The threshold value for the predicate.</value>
        ...
        {
            return this.Equals(input as ProposedProofPred);
        }

        /// <summary>
        /// Returns true if ProposedProofPred instances are equal
        /// </summary>
        /// <param name="input">Instance of ProposedProofPred to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProposedProofPred input)
        {
            if (input == null)
                return false;
