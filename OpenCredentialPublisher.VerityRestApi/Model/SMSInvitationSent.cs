...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SMSInvitationSent :  IEquatable<SMSInvitationSent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SMSInvitationSent" /> class.
        /// </summary>
        /// <param name="type">type.</param>
        /// <param name="id">random id.</param>
        /// <param name="thread">thread.</param>
        /// <param name="invitationId">id of invitation.</param>
        public SMSInvitationSent(string type = default(string), Guid? id = default(Guid?), Thread thread = default(Thread), Guid? invitationId = default(Guid?))
        {
            this.Type = type;
            this.Id = id;
            this.Thread = thread;
        ...
        {
            return this.Equals(input as SMSInvitationSent);
        }

        /// <summary>
        /// Returns true if SMSInvitationSent instances are equal
        /// </summary>
        /// <param name="input">Instance of SMSInvitationSent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SMSInvitationSent input)
        {
            if (input == null)
                return false;
