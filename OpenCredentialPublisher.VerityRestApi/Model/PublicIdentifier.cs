...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PublicIdentifier :  IEquatable<PublicIdentifier>, IValidatableObject
    {

        public PublicIdentifier() { }

        /// <summary>
        /// Initializes a new instance of the <see cref="PublicIdentifier" /> class.
        /// </summary>
        ...
        public PublicIdentifier(Guid? id = default(Guid?), string type = default(string), Thread thread = default(Thread), string verKey = default(string), string did = default(string))
        {
            this.Id = id;
            this.Type = type;
            this.Thread = thread;
        ...
        {
            return this.Equals(input as PublicIdentifier);
        }

        /// <summary>
        /// Returns true if PublicIdentifier instances are equal
        /// </summary>
        /// <param name="input">Instance of PublicIdentifier to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PublicIdentifier input)
        {
            if (input == null)
                return false;
