...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RelationshipInvitationRequest : Body, IEquatable<RelationshipInvitationRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RelationshipInvitationRequest" /> class.
        /// </summary>
        /// <param name="type">type (required) (default to &quot;did:sov:123456789abcdefghi1234;spec/relationship/1.0/connection-invitation&quot;).</param>
        ...
        public RelationshipInvitationRequest(string type = "did:sov:123456789abcdefghi1234;spec/relationship/1.0/connection-invitation", Guid? id = default(Guid?), string forRelationship = default(string), bool? shortInvite = false)
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for RelationshipInvitationRequest and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for RelationshipInvitationRequest and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            {
                throw new InvalidDataException("forRelationship is a required property for RelationshipInvitationRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as RelationshipInvitationRequest);
        }

        /// <summary>
        /// Returns true if RelationshipInvitationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RelationshipInvitationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RelationshipInvitationRequest input)
        {
            if (input == null)
                return false;
