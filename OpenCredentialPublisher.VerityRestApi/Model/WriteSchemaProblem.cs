...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class WriteSchemaProblem :  IEquatable<WriteSchemaProblem>, IValidatableObject
    {

        public WriteSchemaProblem() { }

        /// <summary>
        /// Initializes a new instance of the <see cref="WriteSchemaProblem" /> class.
        /// </summary>
        /// <param name="type">type (required).</param>
        /// <param name="thread">thread (required).</param>
        /// <param name="message">message (required).</param>
        public WriteSchemaProblem(string type = default(string), Thread thread = default(Thread), string message = default(string))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for WriteSchemaProblem and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (thread == null)
            {
                throw new InvalidDataException("thread is a required property for WriteSchemaProblem and cannot be null");
            }
            else
            {
                this.Thread = thread;
            ...
            if (message == null)
            {
                throw new InvalidDataException("message is a required property for WriteSchemaProblem and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as WriteSchemaProblem);
        }

        /// <summary>
        /// Returns true if WriteSchemaProblem instances are equal
        /// </summary>
        /// <param name="input">Instance of WriteSchemaProblem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WriteSchemaProblem input)
        {
            if (input == null)
                return false;
