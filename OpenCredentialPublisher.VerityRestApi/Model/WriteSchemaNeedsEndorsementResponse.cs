...
{
    [DataContract]
    public class WriteSchemaNeedsEndorsementResponse : WriteSchemaResponse, IEquatable<WriteSchemaNeedsEndorsementResponse>
    {

        public WriteSchemaNeedsEndorsementResponse() { }
        public WriteSchemaNeedsEndorsementResponse(string id = default(string), string type = default(string), Thread thread = default(Thread), string schemaId = default(string), string schemaJson = default(string))
            : base(type, thread, schemaId)
        {
            Id = id;
        ...
        [DataMember(Name = "schemaJson", EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as WriteSchemaNeedsEndorsementResponse);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(WriteSchemaNeedsEndorsementResponse input)
        {
            if (input == null)
                return false;
            ...
            return
                ...
                (
                    this.SchemaJson == input.SchemaJson ||
                    (this.SchemaJson != null &&
                    this.SchemaJson.Equals(input.SchemaJson))
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SchemaJson != null)
                    hashCode *= 59 + this.SchemaJson.GetHashCode();
