...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PresentProofStatusReport :  IEquatable<PresentProofStatusReport>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PresentProofStatusReport" /> class.
        /// </summary>
        /// <param name="result">result.</param>
        /// <param name="status">status.</param>
        public PresentProofStatusReport(PresentProofStatusReportResult result = default(PresentProofStatusReportResult), string status = default(string))
        {
            this.Result = result;
            this.Status = status;
        }
        ...
        public PresentProofStatusReportResult Result { get; set; }
        ...
        {
            return this.Equals(input as PresentProofStatusReport);
        }

        /// <summary>
        /// Returns true if PresentProofStatusReport instances are equal
        /// </summary>
        /// <param name="input">Instance of PresentProofStatusReport to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PresentProofStatusReport input)
        {
            if (input == null)
                return false;
