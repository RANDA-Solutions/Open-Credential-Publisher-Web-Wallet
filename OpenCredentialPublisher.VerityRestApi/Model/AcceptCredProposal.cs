...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AcceptCredProposal :  IEquatable<AcceptCredProposal>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AcceptCredProposal" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="type_">type_.</param>
        /// <param name="thread">thread.</param>
        /// <param name="proposal">proposal.</param>
        public AcceptCredProposal(Guid? id = default(Guid?), string type_ = default(string), Thread thread = default(Thread), AcceptCredProposalProposal proposal = default(AcceptCredProposalProposal))
        {
            this.Id = id;
            this.Type_ = type_;
            this.Thread = thread;
        ...
        public AcceptCredProposalProposal Proposal { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Type_: ").Append(Type_).Append("\n");
        ...
        {
            return this.Equals(input as AcceptCredProposal);
        }

        /// <summary>
        /// Returns true if AcceptCredProposal instances are equal
        /// </summary>
        /// <param name="input">Instance of AcceptCredProposal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AcceptCredProposal input)
        {
            if (input == null)
                return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Type_ != null)
                    hashCode = hashCode * 59 + this.Type_.GetHashCode();
                if (this.Thread != null)
