...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class UpdateEndpoint :  IEquatable<UpdateEndpoint>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateEndpoint" /> class.
        /// </summary>
        /// <param name="id">random id.</param>
        /// <param name="type">type (default to &quot;did:sov:123456789abcdefghi1234;spec/configs/0.6/UPDATE_COM_METHOD&quot;).</param>
        /// <param name="comMethod">comMethod.</param>
        public UpdateEndpoint(Guid? id = default(Guid?), string type = "did:sov:123456789abcdefghi1234;spec/configs/0.6/UPDATE_COM_METHOD", UpdateEndpointMethod comMethod = default(UpdateEndpointMethod))
        {
            this.Id = id;
            // use default value if no "type" provided
            if (type == null)
            {
                this.Type = "did:sov:123456789abcdefghi1234;spec/configs/0.6/UPDATE_COM_METHOD";
            }
            else
            {
                this.Type = type;
        ...
        /// <summary>
        /// Gets or Sets ComMethod
        /// </summary>
        [DataMember(Name="comMethod", EmitDefaultValue=false)]
        public UpdateEndpointMethod ComMethod { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ComMethod: ").Append(ComMethod).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as UpdateEndpoint);
        }

        /// <summary>
        /// Returns true if UpdateEndpoint instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateEndpoint to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateEndpoint input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ComMethod == input.ComMethod ||
                    (this.ComMethod != null &&
                    this.ComMethod.Equals(input.ComMethod))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ComMethod != null)
                    hashCode = hashCode * 59 + this.ComMethod.GetHashCode();
                return hashCode;
            }
        }
