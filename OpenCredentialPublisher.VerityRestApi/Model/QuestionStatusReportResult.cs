...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class QuestionStatusReportResult :  IEquatable<QuestionStatusReportResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuestionStatusReportResult" /> class.
        /// </summary>
        /// <param name="type">type.</param>
        /// <param name="thread">thread.</param>
        /// <param name="status">status.</param>
        /// <param name="answer">answer.</param>
        public QuestionStatusReportResult(string type = default(string), Thread thread = default(Thread), string status = default(string), AnswerData answer = default(AnswerData))
        {
            this.Type = type;
            this.Thread = thread;
            this.Status = status;
        ...
        {
            return this.Equals(input as QuestionStatusReportResult);
        }

        /// <summary>
        /// Returns true if QuestionStatusReportResult instances are equal
        /// </summary>
        /// <param name="input">Instance of QuestionStatusReportResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuestionStatusReportResult input)
        {
            if (input == null)
                return false;
