...
namespace OpenCredentialPublisher.VerityRestApi.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class WriteSchemaResponse :  IEquatable<WriteSchemaResponse>, IValidatableObject
    {

        public WriteSchemaResponse() { }

        /// <summary>
        /// Initializes a new instance of the <see cref="WriteSchemaResponse" /> class.
        /// </summary>
        /// <param name="type">type (required).</param>
        /// <param name="thread">thread (required).</param>
        /// <param name="schemaId">schemaId (required).</param>
        public WriteSchemaResponse(string type = default(string), Thread thread = default(Thread), string schemaId = default(string))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for WriteSchemaResponse and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (thread == null)
            {
                throw new InvalidDataException("thread is a required property for WriteSchemaResponse and cannot be null");
            }
            else
            {
                this.Thread = thread;
            ...
            if (schemaId == null)
            {
                throw new InvalidDataException("schemaId is a required property for WriteSchemaResponse and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as WriteSchemaResponse);
        }

        /// <summary>
        /// Returns true if WriteSchemaResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of WriteSchemaResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WriteSchemaResponse input)
        {
            if (input == null)
                return false;
