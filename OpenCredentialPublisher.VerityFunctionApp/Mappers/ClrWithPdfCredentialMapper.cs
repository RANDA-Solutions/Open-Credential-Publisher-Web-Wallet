    ...
    public class ClrWithPdfCredentialMapper : BaseMapper, ICredentialMapper<CredentialMap, ClrWithPdfCredential>
    {
        ...
        public async Task<ClrWithPdfCredential> MapAsync(CredentialMap model)
        {
            ...
            var clr = clrViewModel.RawClrDType;
                ...
                var pdf = clrViewModel.Pdfs.FirstOrDefault();
            ...
            var link = new LinkModel { ClrForeignKey = model.Clr.Id, CredentialRequestId = model.CredentialRequestId, UserId = model.WalletRelationship.UserId, Nickname = $"AutoGenerated-{model.WalletRelationship.WalletName}-{model.WalletRelationship.RelationshipDid}", RequiresAccessKey = true, CreatedAt = DateTimeOffset.UtcNow };
