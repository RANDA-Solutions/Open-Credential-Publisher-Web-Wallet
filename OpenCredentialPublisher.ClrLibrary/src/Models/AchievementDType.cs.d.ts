declare module server {
	...
	interface achievementDType {
		...
		associations: server.associationDType[];
		...
		level: string;
		requirement: server.criteriaDType;
		resultDescriptions: server.resultDescriptionDType[];
