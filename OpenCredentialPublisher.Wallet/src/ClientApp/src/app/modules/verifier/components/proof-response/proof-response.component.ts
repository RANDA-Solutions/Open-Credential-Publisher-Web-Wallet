...
@Component({
  selector: 'app-proof-response',
  templateUrl: './proof-response.component.html',
  styleUrls: ['./proof-response.component.scss']
})
export class ProofResponseComponent implements OnInit {
