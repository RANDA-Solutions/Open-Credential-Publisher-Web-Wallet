...
import { IdentityDType } from "./identityDType";
import { ProfileDType } from "./profileDType";
import { ResultDType } from "./resultDType";
import { VerificationDType } from "./verificationDType";

export class AssertionDType {
