    ...
    public class JwtFactory : IJwtFactory
    {
        ...
        public ClaimsIdentity GenerateClaimsIdentity(ApplicationUser user)
        {
            return new ClaimsIdentity(new GenericIdentity(user.Email, "Token"), new[]
            {
                ...
                new Claim(Helpers.Constants.Strings.JwtClaimIdentifiers.Name, user.Email),
                new Claim(Helpers.Constants.Strings.JwtClaimIdentifiers.PreferredName, user.DisplayName ?? user.Email),
